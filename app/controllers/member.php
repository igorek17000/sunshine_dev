...
class member extends front_base {
	...
	public function register_ok()
	{
		...
		법정 대리인 동의서 다운로드 링크
		*/
		if($_SESSION['kid_auth'] == 'N' || $this->input->get('kid_auth') == 'N'){
			$this->session->unset_userdata('kid_auth');
		...
		$this->session->unset_userdata('tmp_userid');
