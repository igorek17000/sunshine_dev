...
class Board extends front_base {
	...
	**/
	public function view($page = null){
		...
		if( BOARDID != 'goods_qna' && BOARDID != 'goods_review' ) {
			$parentArticleAuthorInfo = $this->Boardmodel->get_parent_article_author_info($_GET['seq']);
		}
		...
		if($page != 'mypage' && !($_GET['mode'] == 'ajax' || $_GET['mode'] == 'layer') )self::index('view');//하단의 리스트출력
