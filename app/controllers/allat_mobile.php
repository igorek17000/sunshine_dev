...
class allat_mobile extends front_base {
	...
	public function allat()
	{
		...
		// 복합과세 처리
		if($_POST['comm_tax_mny'] && $_POST['comm_free_mny']){
			$param['allat_multi_amt'] = $_POST['allat_multi_amt'];
		}
		$param['comm_free_mny']		= $_POST['comm_free_mny'];
		$param['comm_tax_mny']		= $_POST['comm_tax_mny'];
		$param['comm_vat_mny']		= $_POST['comm_vat_mny'];
