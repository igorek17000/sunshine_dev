...
class order_process extends admin_base {
	...
	public function excel_down()
	{
		if($_POST['order_seq']){
			...
			$excel_step				= $_POST['excel_step'];
			$chk_step				= $_POST['chk_step'];
			$excel_provider_seq_selector = $_POST['excel_provider_seq_selector'];
			$excel_provider_seq		= $_POST['excel_provider_seq'];
			$excel_provider_name	= $_POST['excel_provider_name'];
			$excel_ship_set_code	= $_POST['excel_ship_set_code'];
			$excel_type				= $_POST['excel_type'];
			parse_str($_POST['params'], $search_params);
			$search_params['pagemode'] = $_POST['pagemode'];
		}else{
			$form_seq				= $_GET['seq'];
