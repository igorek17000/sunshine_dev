...
//		);
	...
	public function banner_edit(){
		...
		// [반응형스킨] platform 인자값 추가 (기존 프로세스 영향없음) :: 2018-11-08 pjw
				// 배너 스타일
		if($this->config_system['operation_type']=='light') $_GET['platform'] = 'responsive';
		$banner_styles = $this->designmodel->get_banner_styles($_GET['platform']);
	...
	function text_edit(){
		...
		$template_path = str_replace($this->workingSkin.'/', '', $template_path);

		// 해당 템플릿 파일 로드
		$file_path = ROOTPATH."data/skin/".$this->workingSkin.'/'.$template_path;
