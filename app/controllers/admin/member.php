...
{bank_account}  {settleprice}";
		...
		## 공통
			...
			// 회원탈퇴 시
			$use_replace_code['withdrawal'] = array("shopName","shopDomain","userid","username");
			// 아이디 찾기
			...
			// 문자 충전 안내
			$use_replace_code['sms_charge']		= array("remainSms", "shopDomain", "shopName");

			// 무통장자동입금 연장 안내
			$use_replace_code['autodeposit_charge']		= array("remainAutodeposit", "shopDomain", "shopName");

			// 택배자동 연장 안내
			$use_replace_code['goodsflow_charge']		= array("remainGoodsflow", "shopDomain", "shopName");

		## 실물 발송상품
			// 출고완료 시
			$use_replace_code['released']	= array("shopName","shopDomain","ordno","go_item","delivery_company","delivery_number"
													,"userid","order_user","recipient_user","username");
			// 배송완료 시
			$use_replace_code['delivery']	= array("shopName","shopDomain","ordno","go_item","userid","order_user","recipient_user","username");
			//결제취소→환불완료 시
			$use_replace_code['cancel']		= array("shopName","shopDomain","repay_item","userid","order_user","username","ordno");
			// 반품→환불완료 시
			$use_replace_code['refund']		= array("shopName","shopDomain","repay_item","userid","order_user","username","ordno");
			## 티켓 발송 상품
			// 출고완료 시(티켓발송)
			$use_replace_code['coupon_released']	= array("shopName","shopDomain","coupon_serial","couponNum","coupon_value"
														,"options","goods_name","userid","order_user","recipient_user","username");
			// 결제취소→환불완료 시
			...
			$use_replace_code['coupon_delivery']	= array("shopName","shopDomain","coupon_serial","couponNum","coupon_value"
													...
													,"confirm_person","goods_name","userid","order_user","username");
			// 반품→환불완료 시
			$use_replace_code['coupon_refund']		= array("shopName","shopDomain","coupon_serial","couponNum","goods_name"
													,"userid","order_user","username");

			// 휴면회원
			$use_replace_code['dormancy']			= array("userid","shopName","dormancy_du_date","shopDomain", "shopName","username");
