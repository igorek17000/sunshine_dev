...
class common_base_original extends CI_Controller {
	...
	**/
	...
	public function chk_refesh_load(){
		...
		// 부하 예외 체크 path
		if(in_array($this->input->server('REDIRECT_QUERY_STRING'),array('/common/autocomplete','/font/json_font','/goods/option_stock','/coupon/goods_coupon_max','/favicon.ico','/common/ajax_category_favorite'))) return;
