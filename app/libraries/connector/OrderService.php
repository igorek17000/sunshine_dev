...
Class OrderService  extends ServiceBase
{
	...
	public function marketOrderDeliveryBase($fmOrderSeq, $exportInfo, $exportItem) {
		...
		switch($exportInfo['delivery_company_code']) {
			case 'code4' :	//대한통운
			case 'code0' :	//CJ대한통운
			case 'code30' :	//대운통운택배
				$companyCode	= 'D034';
		...
		if(stripos($exportInfo['delivery_company_code'],"auto") !== false){
			$companyCode = $exportInfo['delivery_company_code'];
		}
