...
class goodsLibrary
{
    ...
    function get_goods_config($auth,$isAdmin=false,$isSellerAdmin=false,$goodsKind='goods'){
		...
		$arr_gl_gooda_config 	= array(
            ...
            'excel_sample_url'		=> get_interface_sample_path('20181011/goodsexcel.sample.xlsx'),
			'isAdmin'				=> $isAdmin,
        ...
        if(serviceLimit('H_AD')){
            $arr_gl_gooda_config['excel_sample_url'] = get_interface_sample_path('20181011/goodsexcel.admin.sample.xlsx');
            $arr_gl_gooda_config['excel_sample_url_seller'] = get_interface_sample_path('20181011/goodsexcel.seller.sample.xlsx');
        }
