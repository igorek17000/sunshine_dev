...
class KakaoService extends KakaoBaseService
{
    ...
    {
        $callUrl = "https://kauth.kakao.com/oauth/token?grant_type=refresh_token&client_id=" . $this->REST_API_KEY . "&refresh_token=" . $_SESSION["kakao_refresh_token"] . "&client_secret=" . $this->CLIENT_SECRET;
