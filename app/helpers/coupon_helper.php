...
function downloadlist_tab1($today, $datarow, $coupons) {
	...
	if($datarow['type'] == 'offline_emoney' ) {
		...
		$datarow['issuedate'] = ($datarow['issue_startdate'] && $datarow['issue_enddate'])?substr($datarow['issue_startdate'],2,10).' <br/> '.substr($datarow['issue_enddate'],2,10):''.getAlert("sy054").'';	// 기간제한없음
