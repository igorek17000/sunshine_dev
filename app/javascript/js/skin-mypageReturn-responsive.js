...
$(function(){
	...
	$("input[name='chk_shipping_seq']").change(function(){
		...
		if($(this).is(":checked")){
			$(shippingGroupObj).children(".res_table").css('opacity',1);
			$(shippingGroupObj).find("ul").not("[disabledscript='1']").find("*").removeAttr("disabled");
	...
	$("[name='submitButton']").bind('click',function(){
		...
		openDialogConfirm(getAlert('mp135'),480,140,function(){
