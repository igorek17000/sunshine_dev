	...
	switch(current_page){
		...
		case 'stockmove':
			...
			var thHeader		= [[{'title':'', 'chkClass':'chk','rowspan':2}, 
									...
									{'title':'단가(KRW)', 'addHTML':'</br><div><input type="text" class="excel_table_batch_val " style="width:40%;" /> <span class="btn small gray"><button type="button" onclick="(this, \'supply\');" class="resp_btn v2 arrow">▼</button></span></div>'}, 
									{'title':'금액(KRW) <span class="tooltip_btn" onclick="showTooltip(this, \'/admin/tooltip/scm\', \'#tip13\', \'180\')"></span>'}, 
									{'title':'로케이션'}, 
