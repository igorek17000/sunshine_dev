<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/member/register_ok.html 000002721 */ ?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ 회원가입 완료 @@
...
<?php if($TPL_VAR["userInfo"]){?>
		<li><a class="btn_resp size_c color2" href="../mypage/myinfo" designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWVtYmVyL3JlZ2lzdGVyX29rLmh0bWw=" >회원정보수정</a></li>
<?php }else{?>
		<li><a class="btn_resp size_c color2" href="../member/login?return_url=<?php echo urlencode('../main/index')?>"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWVtYmVyL3JlZ2lzdGVyX29rLmh0bWw=" >로그인</span></a></li>
<?php }?>
		<li><a class="btn_resp size_c color4" href="../main" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWVtYmVyL3JlZ2lzdGVyX29rLmh0bWw=" >쇼핑하러가기</a></li>
	</ul>
</div>
<?php }?>