<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/member/register_form.html 000041278 */ 
...
<?php if($TPL_VAR["member_seq"]&&($TPL_VAR["joinform"]["email_use"]=='Y'||$TPL_VAR["joinform"]["cellphone_use"]=='Y')){?>
			<ul>
				<li class="th "><p designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWVtYmVyL3JlZ2lzdGVyX2Zvcm0uaHRtbA==" >마케팅 및 광고 활용 동의</p><a href="javascript:void(0)" onclick="showCenterLayer('#marketingDeatilLayer')"><span class="ml10 Und">보기</span></a></li>
				<li class="td">
					<div class="Pt10">
<?php if($TPL_VAR["joinform"]["email_use"]=='Y'){?>
...
<?php if($TPL_memberIcondata_1){$TPL_I1=-1;foreach($TPL_VAR["memberIcondata"] as $TPL_V1){$TPL_I1++;?>
							<li>
								<label class="lab1">
									...
									<img src="/data/icon/member/<?php echo $TPL_V1?>" class="icon_membericon"/>
								</label>
							</li>
<?php }}?>
<?php if($TPL_VAR["member_seq"]){?>
							<li>
								<label class="lab1 L">
									...
									<img src="/data/icon/member/<?php echo $TPL_VAR["user_icon_file"]?>" id="membericon_img" <?php if(!$TPL_VAR["user_icon_file"]){?> class="hide" <?php }?> />
								</label>
							</li>
<?php }?>
					</ul>
...
<?php if($TPL_VAR["member_seq"]&&($TPL_VAR["joinform"]["bemail_use"]=='Y'||$TPL_VAR["joinform"]["bcellphone_use"]=='Y')){?>
		<ul>
			<li class="th "><p designElement="text" textIndex="63"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbWVtYmVyL3JlZ2lzdGVyX2Zvcm0uaHRtbA==" >마케팅 및 광고 활용 동의</p><a href="javascript:void(0)" onclick="showCenterLayer('#marketingDeatilLayer')"><span class="ml10 Und">보기</span></a></li>
			<li class="td">
				<div class="Pt10">
<?php if($TPL_VAR["joinform"]["bemail_use"]=='Y'){?>
