<?php /* Template_ 2.2.6 2022/06/09 11:59:34 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/order/settle.html 000094069 */  $this->include_("showNaverMileageButton","sslAction");
						...
						<div class="cart_goods_detail">
							...
							<div class="cgd_contents">
								<div class="block block1">
									<ul>
										<li class="img_area">
											<a href="../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>"><img src="<?php echo $TPL_V2["image"]?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_list.gif'" /></a>
										</li>
...
<?php }?>
											...
											<div class="goods_name v2">
												<a href="../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>"><?php echo $TPL_V2["goods_name"]?></a>
											</div>
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/auth_img.png" alt="성인" class="icon1" />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/plane.png" alt="해외배송상품" class="icon2" />
<?php }?>
<?php if($TPL_V2["cancel_type"]=='1'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/nocancellation.gif" alt="청약철회" class="icon3" />
<?php }?>
<?php if($TPL_V2["tax"]=='exempt'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/taxfree.gif" alt="비과세" class="icon4" />
<?php }?>
											</div>
<?php }?>
...
<?php if($TPL_V3["input_title"]){?><span class="xtle v2"><?php echo $TPL_V3["input_title"]?></span><?php }?>
														<a href="/mypage_process/filedown?file=<?php echo $TPL_V3["input_value"]?>" target="actionFrame" title="크게 보기"><img src="/mypage_process/filedown?file=<?php echo $TPL_V3["input_value"]?>" class="inputed_img" /></a>
<?php }else{?>
<?php if($TPL_V3["input_title"]){?><span class="xtle v2"><?php echo $TPL_V3["input_title"]?></span><?php }?>
...
<?php if(get_gift_image($TPL_V2,'list1')){?>
						<img class="img1" src="<?php echo get_gift_image($TPL_V2,'list1')?>" alt="" />
<?php }?>
...
<?php if($TPL_VAR["members"]){?>
				<ul class="settle_tab delivery_choice clearbox">
					...
					<li class="input_tab"><a href="javascript:;">신규/수정</a></li>
				</ul>
...
<?php if(!defined('__ISUSER__')){?>
								<li>
									<a class="agree_view" href="javascript:void(0)">보기</a>
...
<div class="nation resp_layer_pop hide">
	...
	<div class="y_scroll_auto">
		<p class="now_shipping_nation">
			...
			<img id="nation_img" src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_VAR["ini_info"]["nation"]?>.png" alt=""></dt>
		</p>
...
<?php if($TPL_ship_gl_arr_1){foreach($TPL_VAR["ship_gl_arr"] as $TPL_K1=>$TPL_V1){?>
				<li onclick="chg_shipping_nation('<?php echo $TPL_V1["nation_str"]?>');">
					<span class="nation_flag">
						<img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_VAR["ship_gl_list"][$TPL_K1]['gl_nation']?>.png" alt="">
					</span>
...
<div id="couponDeatilLayer" class="resp_layer_pop hide">
	...
	<a href="/mypage/coupon" class="btn_resp btn_view_coupons" target="_blank">보유 쿠폰 전체 보기</a>
	<a href="javascript:void(0)" class="btn_pop_close" onclick="hideCenterLayer()"></a>
</div>
