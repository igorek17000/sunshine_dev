<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/order/cart.html 000033640 */ 
		...
		<div class="cart_list">
			<ul class="shipping_group_list">
				<li class="goods_delivery_info clearbox" id="sippingInfo{..shipping_group_seq}">
					<ul class="detail">
						<li><span >현재 배송 국가 : <strong><?php echo getstrcut($TPL_VAR["ini_info"]["kr_nation"], 10)?></strong> <img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_VAR["ini_info"]["nation"]?>.png" height="20" alt=""></span></li>
								...
								<dl class="clearbox">
									<dt>
										<h5 class="title_sub3 Pt5 Pb5">
											현재 배송 국가 : <strong><?php echo getstrcut($TPL_VAR["ini_info"]["kr_nation"], 10)?></strong> <img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_VAR["ini_info"]["nation"]?>.png" height="20" alt="">
										</h5>
									</dt>
									<dd>
...
<?php if($TPL_ship_gl_arr_1){foreach($TPL_VAR["ship_gl_arr"] as $TPL_K1=>$TPL_V1){?>
											<tr onclick="chg_shipping_nation('<?php echo $TPL_V1["nation_str"]?>');">
												<td class="hand">
													<img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_VAR["ship_gl_list"][$TPL_K1]['gl_nation']?>.png" style="text-align: left;" alt=""> <?php echo $TPL_VAR["ship_gl_list"][$TPL_K1]['gl_nation']?>
