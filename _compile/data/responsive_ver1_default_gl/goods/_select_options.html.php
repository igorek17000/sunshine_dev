<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/_select_options.html 000035950 */ 
...
<?php if($TPL_V1["input_value"]){?>
					<td><img src="/data/order/<?php echo $TPL_V1["input_value"]?>" id="prevImg" style="height:20px;" /></td>
<?php }else{?>
...
<?php }?>
						...
						<ul class="num_price">
							...
							<li class="option_col_price">
								...
								<img src="/data/skin/responsive_ver1_default_gl/images/common/icon_close_gray.png" class="removeOption" />
							</li>
						</ul>
					</td>
				</tr>
...
<?php if($TPL_V2["input_value"]){?>
									<td><img src="/data/order/<?php echo $TPL_V2["input_value"]?>" class="prevImg" style="height:20px;" /></td>
<?php }else{?>
									<td><img src="about:blank;" class="prevImg" style="display:none;height:20px;" /></td>
<?php }?>
