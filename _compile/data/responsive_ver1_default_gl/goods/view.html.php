<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/view.html 000106744 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php }?>
<?php }else{?>
							<img src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_wide.gif'" title="<?php echo $TPL_V1["large"]["label"]?>" <?php if($TPL_VAR["goods_view_image_alt"]){?>alt="<?php echo $TPL_VAR["goods_view_image_alt"]?>"<?php }?>/>
<?php }?>
					</div>
<?php }?>
<?php }}?>
...
<?php if($TPL_V1["thumbView"]["image"]){?>
							<li><a href="javascript:void(0)"><img src="<?php echo $TPL_V1["thumbView"]["image"]?>" width="<?php echo $TPL_VAR["goodsImageSize"]["thumbView"]["width"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_list.gif'" <?php if($TPL_V1["thumbView"]["match_color"]){?> color="<?php echo $TPL_V1["thumbView"]["match_color"]?>"<?php }?> /></a></li>
<?php }?>
<?php }}?>
						</ul>
					</div>
...
<?php if($TPL_VAR["braodcastData"]["status"]=='live'){?>
						<img class="status" src="/data/skin/responsive_ver1_default_gl/images/broadcast/i_live.png" alt="방송 중">
						<p class="notice_text"><?php echo $TPL_VAR["braodcastData"]["start_date"]?> 현재 방송 중</p>
						<a class="btn_resp no_border" href="/broadcast/player?no=<?php echo $TPL_VAR["braodcastData"]["bs_seq"]?>" target="_blank"><img src="/data/skin/responsive_ver1_default_gl/images/broadcast/btn_live_go.png" alt="시청하기"></a>
<?php }else{?>
						<img class="status" src="/data/skin/responsive_ver1_default_gl/images/broadcast/reserve_live.png" alt="방송 예정 LIVE">
...
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<img src="/data/skin/responsive_ver1_default_gl/images/common/icon_inter_ship.png" class="icon_global" alt="" />
<?php }?>
						</li>
						<li>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
...
<?php if($TPL_VAR["goods"]["mobile_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="122"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1">원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
...
<?php if($TPL_VAR["goods"]["common_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="124"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1">원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
