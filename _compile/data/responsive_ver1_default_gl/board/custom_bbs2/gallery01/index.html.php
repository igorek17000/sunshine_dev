<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/board/custom_bbs2/gallery01/index.html 000013222 */  $this->include_("sslAction");
...
<?php if($TPL_V1["file_key_w"]&&$TPL_V1["uccdomain_thumbnail"]){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["uccdomain_thumbnail"]?>" /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'http')){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="http<?php echo str_replace('http','',$TPL_V1["filelist"]['realfile'])?>" /></span>
<?php }elseif(strstr($TPL_V1["filelist"]['realfile'],'/data/editor/')){?>
				<span class="boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>" board_seq="<?php echo $TPL_V1["seq"]?>"  board_id="<?php echo $_GET["id"]?>"><img class="image_thumb" src="<?php echo $TPL_V1["filelist"]['realfile']?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage.gif'" /></span>
<?php }else{?>
...
<?php }?>
		...
		<ul class="text_area">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[subject]')){?>
			<li class="c_subject boad_view_btn<?php echo $TPL_V1["isperm_read"]?>" viewlink="<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>"  viewtype="<?php echo $TPL_VAR["manager"]["viewtype"]?>"  pagetype="<?php echo $TPL_VAR["pagetype"]?>"  board_seq="<?php echo $TPL_V1["seq"]?>" board_id="<?php echo $_GET["id"]?>">
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li class="c_hit">조회 <?php echo $TPL_V1["hit"]?></li><?php }?>
			<li class="c_short_code" onclick="location.href='<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>';"><?php echo $TPL_V1["contentcut"]?></li>
			<li class="c_more" onclick="location.href='<?php echo $TPL_VAR["boardurl"]->view?><?php echo $TPL_V1["seq"]?>';">READ MORE</li>
		</ul>
	</li>
<?php }}?>
</ul>
