<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/board/goods_qna/_goods_qna/index.html 000016499 */  $this->include_("sslAction");
...
<?php if($TPL_VAR["noticeloop"]||$TPL_VAR["loop"]){?>
	<div class="res_table">
		<ul class="thead">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li style="width:45px;"><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >번호</span></li><?php }?>
			<li style="width:80px;"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >상태</span></li>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li style="width:45px;"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >조회</span></li><?php }?>
		</ul>
<?php if($TPL_VAR["noticeloop"]){?>
<?php if($TPL_noticeloop_1){foreach($TPL_VAR["noticeloop"] as $TPL_V1){?>
		<ul class="tbody notice">
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="num"><span class="mtitle" designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >공지</span> <?php echo $TPL_V1["number"]?></li><?php }?>
			<li class="mo_hide"><span class="pointcolor" designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >공지</span></li>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >조회:</span> <?php echo number_format($TPL_V1["hit"])?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
<?php if($TPL_VAR["loop"]){?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[num]')){?><li class="mo_hide"><span class="mtitle" designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >번호:</span> <?php echo $TPL_V1["number"]?></li><?php }?>
...
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[date]')){?><li><?php echo $TPL_V1["date"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[score]')&&$TPL_VAR["manager"]["auth_recommend_use"]=='Y'){?><li><span class="mtitle"><?php echo $TPL_VAR["manager"]["scoretitle"]?>:</span> <?php echo $TPL_V1["recommendlay"]?></li><?php }?>
<?php if(strstr($TPL_VAR["manager"]["list_show"],'[hit]')){?><li><span class="mtitle" designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >조회:</span> <?php echo number_format($TPL_V1["hit"])?></li><?php }?>
		</ul>
<?php }}?>
<?php }?>
	</div>
...
<ul class="bbs_bottom_wrap">
	<li class="right">
		<button type="button" name="boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>" <?php if($_GET["iframe"]){?>id="goods_boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>"<?php }else{?>id="boad_write_btn<?php echo $TPL_VAR["manager"]["isperm_write"]?>"<?php }?> board_id="<?php echo $TPL_VAR["boardid"]?>" fileperm_read="<?php echo $TPL_VAR["manager"]["fileperm_write"]?>" class="btn_resp size_b color2" /><?php echo $TPL_VAR["manager"]["name"]?> <span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvYm9hcmQvZ29vZHNfcW5hL19nb29kc19xbmEvaW5kZXguaHRtbA==" >쓰기</span></button>
	</li>
</ul>
