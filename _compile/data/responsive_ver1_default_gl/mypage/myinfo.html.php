<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/mypage/myinfo.html 000019027 */  $this->include_("sslAction");
...
<div class="subpage_wrap">
	...
	<div class="subpage_container">
		...
		<div class="title_container">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL215aW5mby5odG1s" >회원정보 수정</span></h2>
		</div>
...
<?php if($TPL_VAR["snslist"]){?>
			<h3 class="title_sub1"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL215aW5mby5odG1s" >사용중인 SNS 계정</span></h3>
<?php if($TPL_snslist_1){foreach($TPL_VAR["snslist"] as $TPL_V1){?>
				<img src="/data/skin/responsive_ver1_default_gl/images/design/mypage_sns_<?php echo substr($TPL_V1["rute"], 0, 1)?>.png"  class="hand" snstype="<?php echo $TPL_V1["rute"]?>"  alt="<?php echo $TPL_VAR["joinform"]["use_sns"][$TPL_V1["rute"]]['nm']?>"  title="<?php echo $TPL_VAR["joinform"]["use_sns"][$TPL_V1["rute"]]['nm']?>" height="42" />
...
<?php }?>
			...
			<h3 class="title_sub1"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL215aW5mby5odG1s" >SNS 계정 사용</span></h3>
			<p class="Pb8" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL215aW5mby5odG1s" >사용하고 계신 SNS 또는 외부 계정으로 간편하게 로그인하여 쇼핑몰을 이용하실 수 있습니다. 여러 개를 함께 이용하실 수도 있습니다.</p>
...
<?php }?>
			...
			<h3 class="title_sub1"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbXlwYWdlL215aW5mby5odG1s" >회원정보</span></h3>
...
<?php if(in_array($TPL_K1,$TPL_VAR["sns_joined_list"])){?>
				<li>
					<img src="/data/skin/responsive_ver1_default_gl/images/design/mypage_sns_<?php echo substr($TPL_K1, 0, 1)?>.png" class="icon" snstype="sns_<?php echo substr($TPL_K1, 0, 1)?>"  snsrute="<?php echo $TPL_K1?>" alt="<?php echo $TPL_V1["nm"]?>"  title="<?php echo $TPL_V1["nm"]?>"  />
			...
			<div class="layer_pop_contents v5">
				<div class="resp_join_table th_size2">
					...
					<ul>
						...
						<li class="td">
							<input type="password" name="password" value="" class="eng_only" style="width:200px;" />
						</li>
					</ul>
					<ul>
