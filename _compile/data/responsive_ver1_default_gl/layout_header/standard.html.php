<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/layout_header/standard.html 000025556 */  $this->include_("showSearchRecent","dataGoodsTodayLight","showDesignBanner","showTopPromotion","showCategoryLightNavigation");
...
<?php }}?>
			...
			<!-- bookmark -->
			<a class="bookmark" href="<?php echo $TPL_VAR["bookmark"]?>" title="북마크"><img src="/data/skin/responsive_ver1_default_gl/images/common/icon_bookmark.png" alt="bookmark" /> <span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >BOOKMARK</span></a>
...
<?php }elseif($TPL_VAR["sess_order"]){?>
				<li><a href="/login_process/logout" target= "actionFrame" designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >LOGOUT</a></li>
<?php }else{?>
...
<?php }?>
				...
				<li class="respCartArea"><a href="/order/cart"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s" >CART</span><span class="cart_cnt1"><?php echo $TPL_VAR["push_count_cart"]?></span></a></li>
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/' target='_self'><img src="/data/skin/responsive_ver1_default_gl/images/design/resp_logo_sample.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>"></a>
			</h1>
...
<?php if($TPL_V1["wish"]){?>
												<img src="/data/icon/goodsdisplay/preview/thumb_zzim_off.png" class="zzimOffImg"  alt="찜하기" style="display:none" data-member="<?php echo $TPL_VAR["userInfo"]["member_seq"]?>" data-goods="<?php echo $TPL_V1["goods_seq"]?>" data-wish="<?php echo $TPL_V1["wish"]?>" onclick="setWish(this)">
												<img src="/data/icon/goodsdisplay/preview/thumb_zzim_on.png" class="zzimOnImg" alt="찜하기" data-member="<?php echo $TPL_VAR["userInfo"]["member_seq"]?>" data-goods="<?php echo $TPL_V1["goods_seq"]?>" data-wish="<?php echo $TPL_V1["wish"]?>" onclick="setWish(this)">
<?php }else{?>
												<img src="/data/icon/goodsdisplay/preview/thumb_zzim_off.png" class="zzimOffImg" alt="찜하기" data-member="<?php echo $TPL_VAR["userInfo"]["member_seq"]?>" data-goods="<?php echo $TPL_V1["goods_seq"]?>" data-wish="<?php echo $TPL_V1["wish"]?>" onclick="setWish(this)">
												<img src="/data/icon/goodsdisplay/preview/thumb_zzim_on.png" class="zzimOnImg" alt="찜하기" style="display:none" data-member="<?php echo $TPL_VAR["userInfo"]["member_seq"]?>" data-goods="<?php echo $TPL_V1["goods_seq"]?>" data-wish="<?php echo $TPL_V1["wish"]?>" onclick="setWish(this)">
<?php }?>
											</div>
...
<?php }}?>
			...
			<a href="/order/cart" class="resp_top_cart"><span class="cart_cnt2"><?php echo $TPL_VAR["push_count_cart"]?></span></a>

			<!-- 슬라이드 배너 영역 (light_style_1_2) :: START -->
			<div class="gnb_bnr_slide gnb_bnr_slide_02 slider_before_loading" style="position:absolute; right:40px; top:0px; width:220px; height:148px;">
				<div class="slider_gon">
					<?php echo showDesignBanner( 2)?>
