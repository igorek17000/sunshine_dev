<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/selleradmin/skin/default/_modules/common/html_header.html 000007072 */  $this->include_("defaultScriptFunc");?>
...
<?php }else{?>
<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/layout-org.css?v=<?php echo date('Ymd')?>" />
<?php if(!preg_match('/admin\/order/',$_SERVER["REDIRECT_QUERY_STRING"])&&!preg_match('/admin\/refund/',$_SERVER["REDIRECT_QUERY_STRING"])&&!preg_match('/admin\/returns/',$_SERVER["REDIRECT_QUERY_STRING"])&&!preg_match('/admin\/export/',$_SERVER["REDIRECT_QUERY_STRING"])&&!preg_match('/refund/',$_SERVER["REDIRECT_QUERY_STRING"])&&!preg_match('/eye_editor\//',$_SERVER["REQUEST_URI"])&&!preg_match('/batch_status/u',$_SERVER["REDIRECT_QUERY_STRING"])){?>
		<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/common-ui-org.css?mm=<?php echo date('Ymd')?>" >
<?php }else{?>
<?php if(preg_match('/order\//',$_SERVER["REQUEST_URI"])||preg_match('/export\//',$_SERVER["REQUEST_URI"])||preg_match('/refund\//',$_SERVER["REQUEST_URI"])||preg_match('/returns\//',$_SERVER["REQUEST_URI"])){?>
	<link rel="stylesheet" type="text/css" href="/selleradmin/skin/default/css/order-org.css?v=<?php echo date('Ymd')?>" />
<?php }?>
<?php }?>
<?php }?>
