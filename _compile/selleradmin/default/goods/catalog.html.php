<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/selleradmin/skin/default/goods/catalog.html 000014814 */  $this->include_("showBatchGoodsData");
...
<link rel="stylesheet" type="text/css" href="../skin/default/css/layer_stock.css?mm=<?php echo date('Ymd')?>">
	...
	<div class="table_row_frame">
		<div class="dvs_top">	
			...
			<div class="dvs_right">	
				...
				<button type='button' name='excel_down_btn' class='btn_excel_down resp_btn v3' data-kind="goods"><img src="/admin/skin/default/images/common/btn_img_ex.gif" /> 다운로드</button></button>
			</div>
		</div>
...
<?php if($TPL_V1["display_terms"]=='AUTO'){?>
					<span class="display-terms-<?php echo $TPL_V1["goods_seq"]?> underline black" onclick="openGoodsDisplayTerms('<?php echo $TPL_V1["goods_seq"]?>');">노출 예약</span><br/>
<?php }?>
