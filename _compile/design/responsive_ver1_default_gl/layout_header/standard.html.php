<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/layout_header/standard.html 000028764 */  $this->include_("showSearchRecent","dataGoodsTodayLight","setTemplatePath","showDesignBanner","showTopPromotion","showCategoryLightNavigation");
...
<?php }?>
	...
	<div class="logo_wrap">
		<div class="resp_wrap">
			<!-- logo -->
			<h1 class="logo_area">
				<a href='/' target='_self' hrefOri='Lw==' ><img src="/data/skin/responsive_ver1_default_gl/images/design/resp_logo_sample.png" alt="<?php echo $TPL_VAR["config_basic"]["companyName"]?>" designImgSrcOri='Li4vaW1hZ2VzL2Rlc2lnbi9yZXNwX2xvZ29fc2FtcGxlLnBuZw==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvZGVzaWduL3Jlc3BfbG9nb19zYW1wbGUucG5n' designElement='image' ></a>
			</h1>
...
<?php }}?>
			...
			<div class="gnb_bnr_slide gnb_bnr_slide_02 slider_before_loading" style="position:absolute; right:40px; top:0px; width:220px; height:148px;">
				<div class="slider_gon">
					<?php echo setTemplatePath('layout_header/standard.html')?><?php echo showDesignBanner( 2)?>
			...
			<div class="nav_category_area">
				<div class="designCategoryNavigation">
					<ul class="respCategoryList">
						...
						<li class="custom_nav_link">
							<a class="categoryDepthLink" designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvbGF5b3V0X2hlYWRlci9zdGFuZGFyZC5odG1s"  href="/board/?id=custom_bbs2" hrefOri='L2JvYXJkLz9pZD1jdXN0b21fYmJzMg==' ><em>STORY</em></a>
						</li>
					</ul>
				</div>
			</div>
