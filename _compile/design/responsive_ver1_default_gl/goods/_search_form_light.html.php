<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/_search_form_light.html 000025333 */  $this->include_("assignBrandBestIcon","setTemplatePath","showCategoryRecommendDisplay","showBrandRecommendDisplay","showLocationRecommendDisplay");
...
<?php if($TPL_VAR["aFilterConfig"]["category"]){?>
		<li class="filter_section filter_category_section">
			<div class="filter_menu_area on">
				<a class="menuThebogi" href="#" hrefOri='Iw==' >카테고리</a>
			</div>
...
<?php if(end(explode('/',uri_string()))!='catalog'){?>
					<a href="javascript:void(0)" class="mobile_pre_cate" data-searchname="pre" onclick="setFilterCategory(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >상위 카테고리</a>
					<a href="javascript:void(0)" class="pc_all_cate" data-searchname="all" onclick="setFilterCategory(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span class="name">전체</span></a>
<?php }?>
<?php if($TPL_VAR["categoryData"]["category_code"]){?>
					<a href="javascript:void(0)" class="mobile_pre_cate" data-searchname="pre" onclick="setFilterCategory(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >상위 카테고리</a>
					<a href="javascript:void(0)" data-searchname="navi_category_<?php echo $TPL_VAR["categoryData"]["category_code"]?>" data-value="c<?php echo $TPL_VAR["categoryData"]["category_code"]?>" onclick="setFilterCategory(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span class="name"><?php echo $TPL_VAR["categoryData"]["title"]?></span></a>
<?php }?>
...
<?php if($TPL_V1["category_code"]){?>
					<li>
						<a href="javascript:void(0)" data-searchname="category_<?php echo $TPL_V1["category_code"]?>" data-value="c<?php echo $TPL_V1["category_code"]?>" onclick="setFilterCategory(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >
...
<?php if($TPL_VAR["aFilterConfig"]["location"]){?>
		<li class="filter_section filter_location_section">
			<div class="filter_menu_area on">
				<a class="menuThebogi" href="#" hrefOri='Iw==' >지역</a>
			</div>
			<div class="filter_detail_area">
				<div class="message">
					지역이 없습니다.
...
<?php if(end(explode('/',uri_string()))!='location'){?>
					<a href="javascript:void(0)" class="mobile_pre_location" data-searchname="pre" onclick="setFilterLocation(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >상위 지역</a>
					<a href="javascript:void(0)" class="pc_all_location" data-searchname="all" onclick="setFilterLocation(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span class="name">전체</span></a>
<?php }?>
<?php if($TPL_VAR["locationData"]["location_code"]){?>
					<a href="javascript:void(0)" class="mobile_pre_location" data-searchname="pre" onclick="setFilterLocation(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >상위 지역</a>
					<a href="javascript:void(0)" data-searchname="navi_location_<?php echo $TPL_VAR["locationData"]["location_code"]?>" data-value="l<?php echo $TPL_VAR["locationData"]["location_code"]?>" onclick="setFilterLocation(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span class="name"><?php echo $TPL_VAR["locationData"]["title"]?></span></a>
...
<?php if($TPL_V1["location_code"]){?>
					<li>
						<a href="javascript:void(0)" data-searchname="location_<?php echo $TPL_V1["location_code"]?>" data-value="l<?php echo $TPL_V1["location_code"]?>" onclick="setFilterLocation(this, false);" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >
...
<?php if($TPL_VAR["aFilterConfig"]["brand"]){?>
		<li class="filter_section filter_brand_section">
			<div class="filter_menu_area">
				<a class="menuThebogi" href="#" hrefOri='Iw==' >브랜드</a>
			</div>
			<div class="filter_detail_area">
				<div class="message">
					브랜드가 없습니다.
...
<?php if($TPL_V1["best"]=='Y'&&$TPL_VAR["brand_best_icon"]){?>
							<img class="icon" src="<?php echo $TPL_VAR["brand_best_icon"]?>" alt="best" onerror="this.src='/data/icon/goods/error/noimage_list.gif';" designImgSrcOri='e2JyYW5kX2Jlc3RfaWNvbn0=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlYXJjaF9mb3JtX2xpZ2h0Lmh0bWw=' designImgSrc='e2JyYW5kX2Jlc3RfaWNvbn0=' designElement='image' />
<?php }?>
						</label>
					</li>
<?php }?>
...
<?php if($TPL_VAR["aFilterConfig"]["seller"]&&$TPL_VAR["filterProviderList"]){?>
		<li class="filter_section filter_seller_section">
			<div class="filter_menu_area">
				<a class="menuThebogi" href="#" hrefOri='Iw==' >판매자</a>
			</div>			
			<div class="filter_detail_area">
				<div class="message">
					판매자가 없습니다.
...
<?php if($TPL_VAR["filterDelvieryCodes"]||$TPL_VAR["aFilterConfig"]["rekeyword"]||$TPL_VAR["aFilterConfig"]["price"]||($TPL_VAR["filterColors"]&&$TPL_VAR["aFilterConfig"]["color"])){?>
		<li class="filter_section filter_detail_section">
			<div class="filter_menu_area">
				<a class="menuThebogi" href="#" hrefOri='Iw==' >상세</a>
			</div>
			<div class="filter_detail_area">
...
<?php }?>
	...
	<div id="searchFilterSelected" class="search_filter_selected">
		...
		<div class="selected_etc_area">
			<a class="btn_all_cancel" href="#" title="전체해제" onclick="resetParams();" hrefOri='Iw==' ></a>
		</div>
	</div>
...
<?php if(end(explode('/',uri_string()))=='catalog'&&$TPL_VAR["categoryData"]["recommend_display_light_seq"]){?>
	<div id="recommendResult">		
		<?php echo setTemplatePath('goods/_search_form_light.html')?><?php echo showCategoryRecommendDisplay($TPL_VAR["categoryData"]["category_code"])?>

	</div>
<?php }?>
<?php if(end(explode('/',uri_string()))=='brand'&&$TPL_VAR["brandData"]["recommend_display_light_seq"]){?>
	<div id="recommendResult">
		<?php echo setTemplatePath('goods/_search_form_light.html')?><?php echo showBrandRecommendDisplay($TPL_VAR["brandData"]["category_code"])?>

	</div>
<?php }?>	
<?php if(end(explode('/',uri_string()))=='location'&&$TPL_VAR["locationData"]["recommend_display_light_seq"]){?>
	<div id="recommendResult">
		<?php echo setTemplatePath('goods/_search_form_light.html')?><?php echo showLocationRecommendDisplay($TPL_VAR["locationData"]["location_code"])?>
...
<?php }?>
	...
	<ul id="filteredItemSorting" class="filtered_item_sorting">
		<li class="item_total">
			<a href="javascript:void(0)" id="btnFilterOpen" class="total" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span class="num"><?php echo number_format($TPL_VAR["totcount"])?></span>개</a>
		</li>
