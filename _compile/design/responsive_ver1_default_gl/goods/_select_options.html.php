<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/_select_options.html 000037500 */ 
...
<?php if(is_array($TPL_R2=$TPL_V1["options"])&&!empty($TPL_R2)){$TPL_I2=-1;foreach($TPL_R2 as $TPL_V2){$TPL_I2++;?>
					<option value="<?php echo $TPL_V2["opt"]?>" price="<?php echo $TPL_V2["org_basic_price"]?>" consumer_price="<?php echo $TPL_V2["consumer_price"]?>" opt1="<?php echo $TPL_V2["option1"]?>" opt2="<?php echo $TPL_V2["option2"]?>" opt3="<?php echo $TPL_V2["option3"]?>" opt4="<?php echo $TPL_V2["option4"]?>" opt5="<?php echo $TPL_V2["option5"]?>" infomation="<?php echo $TPL_V2["infomation"]?>" class="<?php echo $TPL_V2["chk_stock_class"]?>" seq="<?php echo $TPL_I2?>" <?php if($TPL_V2["chk_stock_class"]=='soldout'){?>disabled<?php }?>><?php echo $TPL_V2["opt_string"]?></option>
<?php }}?>
<?php }?>
				</select>
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="2"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >입력옵션</span></th>
		</tr>
<?php }?>
...
<?php if($TPL_V1["input_value"]){?>
					<td><img src="/data/order/<?php echo $TPL_V1["input_value"]?>" id="prevImg" style="height:20px;" designImgSrcOri='L2RhdGEvb3JkZXIvey5pbnB1dF92YWx1ZX0=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='L2RhdGEvb3JkZXIvey5pbnB1dF92YWx1ZX0=' designElement='image' /></td>
<?php }else{?>
					<td><img src="about:blank;" class="prevImg" style="display:none;height:20px;" designImgSrcOri='YWJvdXQ6Ymxhbms7' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='YWJvdXQ6Ymxhbms7' designElement='image' /></td>
<?php }?>
...
<?php if((count($TPL_VAR["options"])> 0&&$TPL_VAR["options"][ 0]["option_title"])&&(($TPL_VAR["suboptions"]&&$TPL_VAR["goods"]["suboption_layout_group"]!='first')||($TPL_VAR["inputs"]&&$TPL_VAR["goods"]["inputoption_layout_position"]!='down'))){?>
		<tr>
			<td colspan="2" align="center" style="padding-top:10px; padding-bottom:10px;">
				<button type="button" class="viewOptionsApply btn_resp size_c color6" style="width:100%"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >위의 정보로 선택</span></button>
			</td>
		</tr>
<?php }?>
...
<?php if(!$TPL_VAR["minimize"]){?>
		<tr>
			<th colspan="2"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=" >추가구성</span></th>
		</tr>
<?php }?>
<?php if($TPL_suboptions_1){$TPL_I1=-1;foreach($TPL_VAR["suboptions"] as $TPL_V1){$TPL_I1++;?>
<?php if($TPL_V1[ 0]["sub_required"]=='y'){?>
...
<?php }?>
						...
						<ul class="num_price">
							...
							<li class="option_col_price">
								...
								<img src="/data/skin/responsive_ver1_default_gl/images/common/icon_close_gray.png" class="removeOption" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2Nsb3NlX2dyYXkucG5n' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ljb25fY2xvc2VfZ3JheS5wbmc=' designElement='image' />
							</li>
						</ul>
					</td>
				</tr>
...
<?php if($TPL_V2["input_value"]){?>
									<td><img src="/data/order/<?php echo $TPL_V2["input_value"]?>" class="prevImg" style="height:20px;" designImgSrcOri='L2RhdGEvb3JkZXIvey4uaW5wdXRfdmFsdWV9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='L2RhdGEvb3JkZXIvey4uaW5wdXRfdmFsdWV9' designElement='image' /></td>
<?php }else{?>
									<td><img src="about:blank;" class="prevImg" style="display:none;height:20px;" designImgSrcOri='YWJvdXQ6Ymxhbms7' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvX3NlbGVjdF9vcHRpb25zLmh0bWw=' designImgSrc='YWJvdXQ6Ymxhbms7' designElement='image' /></td>
<?php }?>
