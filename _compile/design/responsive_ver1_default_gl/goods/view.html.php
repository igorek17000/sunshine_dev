<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/view.html 000112943 */  $this->include_("showCategoryLight","snslinkurl","snsLikeButton","showNaverMileageButton","showCoupons","showNaverMapApi");
...
<?php if($TPL_icons_1){foreach($TPL_VAR["icons"] as $TPL_V1){?>
			<img src="/data/icon/goods/<?php echo $TPL_V1["codecd"]?>.gif" alt="" designImgSrcOri='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvaWNvbi9nb29kcy97LmNvZGVjZH0uZ2lm' designElement='image' >
<?php }}?>
		</span>
	</p>
...
<?php }?>
<?php }else{?>
							<img src="<?php echo $TPL_V1["view"]["image"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_wide.gif'" title="<?php echo $TPL_V1["large"]["label"]?>" <?php if($TPL_VAR["goods_view_image_alt"]){?>alt="<?php echo $TPL_VAR["goods_view_image_alt"]?>"<?php }?> designImgSrcOri='ey52aWV3LmltYWdlfQ==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='ey52aWV3LmltYWdlfQ==' designElement='image' />
<?php }?>
					</div>
<?php }?>
<?php }}?>
				<a id="btn_zoom_view" href="javascript:popup('zoom?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&popup=1',<?php echo ($TPL_VAR["goodsImageSize"]["large"]["width"]+ 17)?>, document.body.clientHeight,'yes')" hrefOri='amF2YXNjcmlwdDpwb3B1cCg=' >확대 보기</a>
			</div>
...
<?php if($TPL_V1["thumbView"]["image"]){?>
							<li><a href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><img src="<?php echo $TPL_V1["thumbView"]["image"]?>" width="<?php echo $TPL_VAR["goodsImageSize"]["thumbView"]["width"]?>" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_list.gif'" <?php if($TPL_V1["thumbView"]["match_color"]){?> color="<?php echo $TPL_V1["thumbView"]["match_color"]?>"<?php }?> designImgSrcOri='ey50aHVtYlZpZXcuaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='ey50aHVtYlZpZXcuaW1hZ2V9' designElement='image' /></a></li>
<?php }?>
<?php }}?>
						</ul>
					</div>
...
<?php }?>
		...
		<input type="hidden" name="goodsViewVersion" value="2" />
			...
			<div class="sns_wish">
				<!-- SNS 공유 -->
				<a href="javascript:void(0)" id="btnSnsShare" class="btn_sns_share" title="SNS 공유" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >공유</span></a>
				<div id="snsListDetail" class="snsbox_area" style="display:none;">
					<?php echo snslinkurl('goods',$TPL_VAR["goods"]["goods_name"])?>

				</div>
				<!-- 찜 -->
				<a href="javascript:void(0)" id="wishimg" class="ico_wish" usewish="n" onclick="wish_chg();" title="찜하기(위시리스트에 추가)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >찜</span></a>
			</div>
...
<?php if($TPL_VAR["eventEnd"]){?>
				<li class="spec_solo_event">
					<ul class="list">
						<li class="buy_num"><strong class="num"><?php echo number_format($TPL_VAR["goods"]["event"]["event_order_ea"])?></strong><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >개 구매중</span></li>
						<li class="remain_time">
							<span class="title"></span>
							<div class="event_datetime_box">
								<span class="num2" id="soloday<?php echo $TPL_VAR["goods"]["goods_seq"]?>">00</span><span class="day" designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >일</span>
...
<?php if($TPL_VAR["braodcastData"]["status"]=='live'){?>
						<img class="status" src="/data/skin/responsive_ver1_default_gl/images/broadcast/i_live.png" alt="방송 중" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9pX2xpdmUucG5n' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvYnJvYWRjYXN0L2lfbGl2ZS5wbmc=' designElement='image' >
						<p class="notice_text"><?php echo $TPL_VAR["braodcastData"]["start_date"]?> 현재 방송 중</p>
						<a class="btn_resp no_border" href="/broadcast/player?no=<?php echo $TPL_VAR["braodcastData"]["bs_seq"]?>" target="_blank" hrefOri='L2Jyb2FkY2FzdC9wbGF5ZXI/bm89e2JyYW9kY2FzdERhdGEuYnNfc2VxfQ==' ><img src="/data/skin/responsive_ver1_default_gl/images/broadcast/btn_live_go.png" alt="시청하기" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9idG5fbGl2ZV9nby5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvYnJvYWRjYXN0L2J0bl9saXZlX2dvLnBuZw==' designElement='image' ></a>
<?php }else{?>
						<img class="status" src="/data/skin/responsive_ver1_default_gl/images/broadcast/reserve_live.png" alt="방송 예정 LIVE" designImgSrcOri='Li4vaW1hZ2VzL2Jyb2FkY2FzdC9yZXNlcnZlX2xpdmUucG5n' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvYnJvYWRjYXN0L3Jlc2VydmVfbGl2ZS5wbmc=' designElement='image' >
						<a href="/broadcast/player?no=<?php echo $TPL_VAR["braodcastData"]["bs_seq"]?>" class="notice_text" target="_blank" hrefOri='L2Jyb2FkY2FzdC9wbGF5ZXI/bm89e2JyYW9kY2FzdERhdGEuYnNfc2VxfQ==' ><?php echo $TPL_VAR["braodcastData"]["start_date"]?> 라이브 쇼핑으로 만나보세요.</a>
<?php }?>
					</div>
				</li>
<?php }?>
...
<?php if((array_sum($TPL_VAR["sales"]["sale_list"])-$TPL_VAR["sales"]["sale_list"]["basic"])> 0){?>
					<button type="button" class="btn_open_small btn_resp B" onclick="detail_contents_toggle(this,'priceDetail')"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >혜택보기</span></button>
...
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
				<li class="goods_spec_unsold">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상태</span></li>
						<li class="td sell_stop"><span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >판매중지</span></li>
					</ul>
				</li>
<?php }?>
				<!-- ~~~~~ //판매중지 ~~~~~ -->
...
<?php if($TPL_VAR["sales"]["mtext_list"]['multi']){?>
				<li class="goods_spec_large_purchase">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >대량구매</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['multi']?>

						</li>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'multi')"><span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['coupon']){?>
				<li class="goods_spec_coupon">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >쿠폰</span></li>
						<li>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['like']&&$TPL_VAR["APP_USE"]=='f'&&$TPL_VAR["APP_LIKE_TYPE"]!='NO'){?>
				<li class="goods_spec_like">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >좋아요</span></li>
						<li>
...
<?php }?>
						...
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'fblikeDetail')"><span designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
...
<?php if(is_array($TPL_R1=$TPL_VAR["fblikesale"]["result"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
							<li>
								<p class="e_title" ><span designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >좋아요 + </span><?php echo get_currency_price($TPL_V1["price1"], 2)?><span designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" > 이상 구매시</span></p>
								<div class="e_content">
...
<?php if($TPL_VAR["sales"]["mtext_list"]['mobile']){?>
				<li class="goods_spec_mobile">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >모바일</span></li>
						<li>
							<?php echo $TPL_VAR["sales"]["mtext_list"]['mobile']?>

						</li>
						<li class="btn_area1">
							<button type="button" class="btn_open_small btn_resp no_border" onclick="detail_contents_toggle(this,'mobileDetail')"><span designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >자세히</span></button>
						</li>
					</ul>
...
<?php if(is_array($TPL_R1=$TPL_VAR["mobilesale"]["result"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
							<li>
								<p class="e_title"><span designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >모바일 + </span><?php echo get_currency_price($TPL_V1["price1"], 2)?><span designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" > 이상 구매시</span></p>
								<div class="e_content">
<?php if(count($TPL_V1["result"])> 1){?>
										<ul class="basic_lr_style">
											<li>최대</li>
					...
					<div id="goodsInterest" class="Relative hide">
						<div class="layer_simple_basic px p_right">
							<table class="detail_option_table card" cellpadding="0" cellspacing="0">
								<tbody>
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_bc.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfYmMuZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19iYy5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_ct.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfY3QuZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19jdC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_hd.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaGQuZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19oZC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_hn.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfaG4uZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19obi5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_kb.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfa2IuZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19rYi5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_lt.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfbHQuZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19sdC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_sh.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc2guZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19zaC5naWY=' designElement='image' ></th>
								...
								<tr>
									<th><img src="/data/skin/responsive_ver1_default_gl/images/common/interest/Interest_img_ss.gif" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pbnRlcmVzdC9JbnRlcmVzdF9pbWdfc3MuZ2lm' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ludGVyZXN0L0ludGVyZXN0X2ltZ19zcy5naWY=' designElement='image' ></th>
...
<?php if($TPL_VAR["goods"]["referer_sale"]["referersale_seq"]){?>
				<li class="goods_spec_referersale_seq">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="43"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >유입경로</span></li>
						<li>
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney_video"]> 0||$TPL_VAR["cfg_reserve"]["autopoint_video"]> 0){?>
							<li>
								<p class="e_title" designElement="text" textIndex="51"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >동영상 상품후기</p>
								<div class="e_content">
...
<?php if($TPL_VAR["cfg_reserve"]["bbs_start_date"]&&$TPL_VAR["cfg_reserve"]["bbs_end_date"]){?>
							<li>
								<p class="e_title" designElement="text" textIndex="52"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >기타 상품후기</p>
								<div class="e_content">
...
<?php if(in_array($TPL_VAR["naver_mileage_yn"],array('y','t'))){?>
				<li class="goods_spec_naver_mileage">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="53"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >네이버 마일리지</span></li>
						<li>
...
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<img src="/data/skin/responsive_ver1_default_gl/images/common/icon_inter_ship.png" class="icon_global" alt="" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9pY29uX2ludGVyX3NoaXAucG5n' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2ljb25faW50ZXJfc2hpcC5wbmc=' designElement='image' />
<?php }?>
						</li>
						<li>
<?php if($TPL_VAR["goods"]["option_international_shipping_status"]=='y'){?>
							<ul class="detail_spec_table sub">
								<li><span designElement="text" textIndex="55"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >해외구매대행 상품, 개인통관고유부호</span></li>
								<li class="btn_area1"><button type="button" class="btn_resp no_border" onclick="detail_contents_toggle(this,'customsDetail')"><span designElement="text" textIndex="56"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >자세히</span></button></li>
							</ul>
<?php }?>
...
<?php if($TPL_V1["delivery_add_input"]){?>
										<div class="add">
											<span designElement="text" textIndex="59"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >추가배송비</span> <?php echo $TPL_V1["delivery_add_input"]?>

										</div>
<?php }?>
<?php if($TPL_V1["delivery_hop_input"]&&!$TPL_VAR["goods"]["reserve_ship_flag"]){?>
										<div class="hop">
											<span designElement="text" textIndex="60"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >희망배송일</span> <?php echo $TPL_V1["delivery_hop_input"]?>
...
<?php if($TPL_VAR["goods"]["reserve_ship_flag"]){?>
							<ul class="detail_spec_table sub">
								<li><span designElement="text" textIndex="62"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >예약판매 :</span> <?php echo $TPL_VAR["goods"]["reserve_ship_txt"]?></li>
							</ul>
<?php }?>
						</li>
					</ul>
...
<?php if($TPL_VAR["ship_summary"]["gl_shipping_yn"]=='Y'){?>
				<li class="goods_spec_international_shipping">
					<ul class="detail_spec_table">
						<li class="th"><span designElement="text" textIndex="72"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >해외배송</span> <img src="/data/skin/responsive_ver1_default_gl/images/common/plane.png" height="15" alt="해외배송" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL3BsYW5lLnBuZw==' designElement='image' /></li>
						<li>
...
<?php if($TPL_ship_gl_list_1){foreach($TPL_VAR["ship_gl_list"] as $TPL_V1){?>
									<tr>
										<th scope="row" class="L">
											<img src="/admin/skin/default/images/common/icon/nation/<?php echo $TPL_V1["gl_nation"]?>.png" height="20" alt="" designImgSrcOri='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2FkbWluL3NraW4vZGVmYXVsdC9pbWFnZXMvY29tbW9uL2ljb24vbmF0aW9uL3suZ2xfbmF0aW9ufS5wbmc=' designElement='image' >
...
<?php if($TPL_VAR["goods"]["review_count"]){?>
				<li class="goods_spec_customer_ev">
					<ul class="detail_spec_table">
						...
						<li>
							<?php echo number_format($TPL_VAR["goods"]["review_count"])?><span designElement="text" textIndex="80"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >명</span>&nbsp;
...
<?php if($TPL_VAR["provider"]["provider_seq"]){?>
				<li class="goods_spec_provider">
					<ul class="detail_spec_table">
						...
						<li>
							<a href="/mshop?m=<?php echo $TPL_VAR["provider"]["provider_seq"]?>" target="_blank" title="새창" hrefOri='L21zaG9wP209e3Byb3ZpZGVyLnByb3ZpZGVyX3NlcX0=' ><?php echo $TPL_VAR["provider"]["provider_name"]?></a>
							<a href="javascript:void(0)" class="reg_minishop v2 <?php if($TPL_VAR["provider"]["thisshop"]=='y'){?>on<?php }?>" title="<?php if($TPL_VAR["provider"]["thisshop"]=='n'){?>단골 등록<?php }?>" data-shop='<?php echo $TPL_VAR["provider"]["provider_seq"]?>' onclick="mshopadd(this, '<?php echo $TPL_VAR["sessionMember"]["member_seq"]?>');" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' ></a>
						</li>
						<li class="btn_area1">
...
<?php }?>
			...
			<div id="goodsBuyOpenSection" class="goods_buy_open_sections">
				<a href="javascript:void(0);" id="btnSectionOpen" class="btn_section_open off" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >열기</a>
...
<?php }?>	
							<li><button type="button" id="buy_btn" class="btn_resp size_c color2"><span designElement="text" textIndex="99"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >구매하기</span></button></li>
						</ul>
					</li>
...
<?php }else{?>
<?php }?>
							<p class="text_soldout NpayNo" designElement="text" textIndex="100"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >품절</p>
						</li>
<?php }?>
...
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
						<li><button type="button" style="width:100%;" class="btn_resp size_c color3 NpayNo"><span designElement="text" textIndex="103"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >판매중지</span></button></li>
<?php }?>
<?php }?>

<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<li>
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="104"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_ver1_default_gl/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvaWNvbi9pY29uX3RhbGsucG5n' designElement='image' />&nbsp; <span designElement="text" textIndex="105"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >톡톡하세요</span></button>
					</li>
<?php }?>
				</ul>
			</div>
			...
			<div id="goodsOptionBuySection" class="goods_buy_sections">
				<a href="javascript:void(0);" id="btnSectionClose" class="btn_section_close" hrefOri='amF2YXNjcmlwdDp2b2lkKDApOw==' >닫기</a>
...
<?php }?>
								<li><button type="button" id="buy" class="btn_resp size_extra2 color2 NpayNo"><span designElement="text" textIndex="109"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >구매하기</span></button></li>
							</ul>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='runout'){?>
...
<?php }else{?>
<?php }?>
							<p class="text_soldout NpayNo" designElement="text" textIndex="110"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >품절</p>
						</li>
<?php }?>
<?php if($TPL_VAR["goods"]["goods_status"]=='purchasing'){?>
						<li>
...
<?php if($TPL_VAR["goods"]["goods_status"]=='unsold'){?>
						<li>
							<button type="button" class="btn_resp size_c color3 NpayNo"><span designElement="text" textIndex="113"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >판매중지</span></button>
						</li>
<?php }?>
					</ul>
<?php }?>
...
<?php if($TPL_VAR["sns"]["ntalk_connect"]=='Y'&&$TPL_VAR["sns"]["ntalk_use"]=='Y'&&$TPL_VAR["sns"]["ntalk_use_mobile_product"]=='Y'){?>
					<div class="goods_naver_talk_pc">
						<button type="button" class="btn_naver_talk" onclick="window.open('https://talk.naver.com/<?php echo $TPL_VAR["sns"]["ntalk_connect_id"]?><?php if($TPL_VAR["sns"]["ntalk_use_sniffet"]=='Y'){?>?ref='+encodeURIComponent(location.href)+'#nafullscreen'<?php }else{?>#nafullscreen'<?php }?>, 'talktalk', 'width=471, height=640'); return false;"><span designElement="text" textIndex="114"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >쇼핑할땐</span> &nbsp;<img src="/data/skin/responsive_ver1_default_gl/images/icon/icon_talk.png" align="absmiddle" alt="네이버톡톡" designImgSrcOri='Li4vaW1hZ2VzL2ljb24vaWNvbl90YWxrLnBuZw==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvaWNvbi9pY29uX3RhbGsucG5n' designElement='image' />&nbsp; <span designElement="text" textIndex="115"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >톡톡하세요</span></button>
					</div>
<?php }?>
				</div>
			</div>
...
<?php if($TPL_VAR["sales"]["mtext_list"]['event']){?>
				<li class="goods_spec_event" style="display:none"><!-- 하단 관련 이벤트와 중복이라 hide 처리함( sjg ) -->
					<ul class="detail_event_area" onclick="detail_contents_toggle(this,'eventDetail'); if( $('#eventDetail').is(':hidden') ) $(this).removeClass('up'); else $(this).addClass('up');">
						<li class="th"><span designElement="text" textIndex="116"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >이벤트</span></li>
						<li>
...
<?php if($TPL_VAR["goods"]["gift"]&&$TPL_VAR["goods"]["gift"]["benifits"]){?>
				<li class="goods_spec_gift">
					<ul class="detail_event_area" onclick="detail_contents_toggle(this,'giftInterest'); if( $('#giftInterest').is(':hidden') ) $(this).removeClass('up'); else $(this).addClass('up');">
						<li class="th"><span designElement="text" textIndex="117"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >사은품</span></li>
						<li>
		...
		<div id="goods_tabs" class="goods_tabs">
			<div class="resp_area">
				<div class="goods_information_tabs">
					<a href="#goods_contents_quick" class="current" onclick="open_information_tab(this,'goods_description');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="118"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상세설명</span></a>
					<a href="#goods_contents_quick" id="goodsReviewLoad" onclick="open_information_tab(this,'goods_review');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span><span designElement="text" textIndex="119"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상품후기</span> <?php if($TPL_VAR["goods"]["review_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["review_count"])?></span><?php }?></span></a>
					<a href="#goods_contents_quick" id="goodsQnaLoad" onclick="open_information_tab(this,'goods_qna');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span><span designElement="text" textIndex="120"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상품문의</span> <?php if($TPL_VAR["goods"]["qna_count"]){?><span class="num"><?php echo number_format($TPL_VAR["goods"]["qna_count"])?></span><?php }?></span></a>
					<a href="#goods_contents_quick" onclick="open_information_tab(this,'exchange_guide');" hrefOri='I2dvb2RzX2NvbnRlbnRzX3F1aWNr' ><span designElement="text" textIndex="121"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >교환/반품/<span class="Dib">배송</span></span></a>
				</div>
			</div>
		</div>
		<script>
...
<?php if($TPL_VAR["goods"]["mobile_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="122"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29udGVudHM/bm89e2dvb2RzLmdvb2RzX3NlcX0mem9vbT0x' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
					<button type="button" class="btn_resp size_b" onclick="document.location.href='/goods/view_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1';"><span designElement="text" textIndex="123"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >원본 보기</span></button>
				</li>
			</ul>
<?php }?>
...
<?php if($TPL_VAR["goods"]["common_contents_images_true"]){?>
			<ul class="guide_origin_image">
				<li><p designElement="text" textIndex="124"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >상세설명 이미지를 자유롭게 확대/축소하시려면 <a href="/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1" hrefOri='L2dvb2RzL3ZpZXdfY29tbW9uX2NvbnRlbnRzP25vPXtnb29kcy5nb29kc19zZXF9Jnpvb209MQ==' >원본 보기</a>에서 가능합니다.</p></li>
				<li class="btn_area">
					<button type="button" class="btn_resp size_b" onclick="document.location.href='/goods/view_common_contents?no=<?php echo $TPL_VAR["goods"]["goods_seq"]?>&zoom=1';"><span designElement="text" textIndex="125"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >원본 보기</span></button>
				</li>
			</ul>
<?php }?>
...
<?php if($TPL_VAR["event_banner"]){?>
		<h3 class="title_sub1"><span designElement="text" textIndex="126"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >관련 이벤트</span></h3>
		<ul class="detail_relation_event">
<?php if($TPL_event_banner_1){foreach($TPL_VAR["event_banner"] as $TPL_V1){?>
			<li><a href="/promotion/<?php echo $TPL_V1["type"]?>_view?<?php echo $TPL_V1["type"]?>=<?php echo $TPL_V1["seq"]?>" target="_blank" title="새창" hrefOri='L3Byb21vdGlvbi97LnR5cGV9X3ZpZXc/ey50eXBlfT17PS5zZXF9' ><span class="title"><?php echo $TPL_V1["title"]?></span><span class="date">(<?php echo $TPL_V1["start_date"]?> ~ <?php echo $TPL_V1["end_date"]?>)</span><span class="e_desc"><?php echo $TPL_V1["goods_desc_popup"]?></span></a></li>
<?php }}?>
		</ul>
<?php }?>
...
<?php if($TPL_VAR["goodsRelationSellerDisplayHTML"]){?>
		<h3 class="title_sub1"><span designElement="text" textIndex="128"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvZ29vZHMvdmlldy5odG1s" >판매자 인기상품</span></h3>
