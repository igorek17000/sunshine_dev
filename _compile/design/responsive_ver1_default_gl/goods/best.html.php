<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/goods/best.html 000002517 */  $this->include_("setTemplatePath","showDesignBanner","showGoodsSearchFormLight");?>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++
@@ "베스트" 리스트 페이지 @@
...
<?php if($TPL_VAR["page_config"]["banner"]["banner_seq"]){?>
	...
	<?php echo setTemplatePath('goods/best.html')?><?php echo showDesignBanner($TPL_VAR["page_config"]["banner"]["banner_seq"],true)?>
