<?php /* Template_ 2.2.6 2022/06/10 06:42:44 /www/suns_firstmall_kr/data/skin/responsive_ver1_default_gl/order/settle.html 000096165 */  $this->include_("showNaverMileageButton","sslAction");
...
<div class="subpage_wrap">
	<div class="subpage_container v3 Pb10">
		...
		<div class="title_container Pb0">
			<h2><span designElement="text" textIndex="1"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >주문/결제</span></h2>
		</div>
	</div>
</div>
...
<div id="orderPaymentLayout" class="subpage_wrap order_payment" data-ezmark="undo">
	<div class="subpage_container v2 Pt0 order_payment_left">
		<!-- 주문상품 :: START -->
		<h2 class="title_od1 Pt15"><span designElement="text" textIndex="2"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >주문상품 정보</span></h2>
						...
						<div class="cart_goods_detail">
							...
							<div class="cgd_contents">
								<div class="block block1">
									<ul>
										<li class="img_area">
											<a href="../goods/view?no=<?php echo $TPL_V2["goods_seq"]?>" hrefOri='Li4vZ29vZHMvdmlldz9ubz17Li5nb29kc19zZXF9' ><img src="<?php echo $TPL_V2["image"]?>" class="goods_thumb" onerror="this.src='/data/skin/responsive_ver1_default_gl/images/common/noimage_list.gif'" designImgSrcOri='ey4uaW1hZ2V9' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=' designImgSrc='ey4uaW1hZ2V9' designElement='image' /></a>
										</li>
...
<?php if($TPL_V2["adult_goods"]=='Y'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/auth_img.png" alt="성인" class="icon1" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9hdXRoX2ltZy5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL2F1dGhfaW1nLnBuZw==' designElement='image' />
<?php }?>
<?php if($TPL_V2["option_international_shipping_status"]=='y'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/plane.png" alt="해외배송상품" class="icon2" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9wbGFuZS5wbmc=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL3BsYW5lLnBuZw==' designElement='image' />
<?php }?>
<?php if($TPL_V2["cancel_type"]=='1'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/nocancellation.gif" alt="청약철회" class="icon3" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi9ub2NhbmNlbGxhdGlvbi5naWY=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL25vY2FuY2VsbGF0aW9uLmdpZg==' designElement='image' />
<?php }?>
<?php if($TPL_V2["tax"]=='exempt'){?>
												<img src="/data/skin/responsive_ver1_default_gl/images/common/taxfree.gif" alt="비과세" class="icon4" designImgSrcOri='Li4vaW1hZ2VzL2NvbW1vbi90YXhmcmVlLmdpZg==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=' designImgSrc='L2RhdGEvc2tpbi9yZXNwb25zaXZlX3ZlcjFfZGVmYXVsdF9nbC9pbWFnZXMvY29tbW9uL3RheGZyZWUuZ2lm' designElement='image' />
<?php }?>
											</div>
<?php }?>
...
<?php if($TPL_V3["input_title"]){?><span class="xtle v2"><?php echo $TPL_V3["input_title"]?></span><?php }?>
														<a href="/mypage_process/filedown?file=<?php echo $TPL_V3["input_value"]?>" target="actionFrame" title="크게 보기" hrefOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLmlucHV0X3ZhbHVlfQ==' ><img src="/mypage_process/filedown?file=<?php echo $TPL_V3["input_value"]?>" class="inputed_img" designImgSrcOri='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLmlucHV0X3ZhbHVlfQ==' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=' designImgSrc='L215cGFnZV9wcm9jZXNzL2ZpbGVkb3duP2ZpbGU9ey4uLmlucHV0X3ZhbHVlfQ==' designElement='image' /></a>
<?php }else{?>
<?php if($TPL_V3["input_title"]){?><span class="xtle v2"><?php echo $TPL_V3["input_title"]?></span><?php }?>
...
<?php if(get_gift_image($TPL_V2,'list1')){?>
						<img class="img1" src="<?php echo get_gift_image($TPL_V2,'list1')?>" alt="" designImgSrcOri='ez1nZXRfZ2lmdF9pbWFnZSguLnZhbHVlXyw=' designTplPath='cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=' designImgSrc='ez1nZXRfZ2lmdF9pbWFnZSguLnZhbHVlXyw=' designElement='image' />
<?php }?>
...
<?php }?>
		...
		<div class="order_subsection v2">
			<!-- ++++++++++++++++++++ 주문자 :: START ++++++++++++++++++++ -->
			<h3 class="title3"><span designElement="text" textIndex="3"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >주문자</span></h3>
...
<?php if($TPL_set_list_1){foreach($TPL_VAR["set_list"] as $TPL_V1){?>
	<option value="<?php echo $TPL_VAR["shipping_set_seq"]?>" nation="<?php echo $TPL_VAR["delivery_nation"]?>"><?php echo $TPL_VAR["shipping_set_name"]?></option>
<?php }}?>
</select>
<!-- 배송설정 :: END -->
		
<li class="goods_spec_coupon2" >
...
<?php }}?>
	...
	<input type="hidden" name="shipping_prepay_info" value="delivery" />
			...
			<!-- ++++++++++++++++++++ 배송지 :: START ++++++++++++++++++++ -->
			<h3 class="title3"><span designElement="text" textIndex="4"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >배송지</span></h3>
...
<?php }?>
				...
				<div class="settle_tab_contents tab_box2 delivery_input" style="display:none">
					<ul class="list_01 v2">
						...
						<li class="international goods_delivery_info <?php if(!$TPL_VAR["is_goods"]){?>hide<?php }?>" >
							<input type="text" name="international_address_input" class="pilsu size_full" value="{.cfg.baserule.shipping_set_name}" title="<?php echo getAlert('os058')?>" required />
...
<?php }}?>
						...
						<li <?php if(!$TPL_VAR["is_goods"]){?>class="hide"<?php }?>>
							...
							<button type="button" class="btn_resp gray_05" onclick="showCenterLayer('.nation')">다른국가선택</button>
						</li>
...
<?php }?>
			...
			<!-- ++++++++++++++++++++ 할인 :: START ++++++++++++++++++++ -->
			<h3 class="title3"><span designElement="text" textIndex="5"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >할인</span></h3>
			<ul class="list_01 v2">
...
<?php if($TPL_VAR["members"]){?>
				<li>
					<span class="od_sale_title">마일리지</span>
					<span class="od_sale_price">
			...
			<div class="right_flying_wrap1">
				<div class="right_flying_wrap2">
					<div class="right_flying_wrap3">
						<!-- ++++++++++++++++++++ 결제 금액 :: START ++++++++++++++++++++ -->
						<h3 class="title3 Pt15">
							<ul class="settle_price_title">
								<li><span designElement="text" textIndex="6"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >결제 금액</span></li>
<?php if($TPL_VAR["btn_estimateyn"]=='y'){?>
								<?php echo $TPL_VAR["btn_estimate_script"]?>

								<li class="estimate_btn_area">
									<span class="btn_estimate btn_resp size_b">견적서</span>
								</li>
<?php }?>
							</ul>
						</h3>
						<div class="order_price_total">
							<ul>
								<li class="th"><span class="gray_01 Fs17" designElement="text" textIndex="7"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >상품금액</span></li>
								<li class="td"><?php echo get_currency_price($TPL_VAR["total"], 2,'','<span id="total_goods_price" class="v2 gray_01">_str_price_</span>')?></li>
							</ul>
							<ul>
								<li class="th">
									<span designElement="text" textIndex="8"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >배송비</span>&nbsp;
									<button type="button" class="btn_resp size_a gray_05" onclick="showCenterLayer('#besongDetailList')"><span designElement="text" textIndex="9"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >내역</span></button>
								</li>
								<li class="td">
							...
							<ul>
								<li class="th">
									<span designElement="text" textIndex="10"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >할인금액</span>&nbsp;
									<button type="button" class="btn_resp size_a gray_05" onclick="showCenterLayer('#saleDetailList')"><span designElement="text" textIndex="11"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >내역</span></button>
								</li>
...
<?php if($TPL_VAR["members"]){?>
							<ul>
								<li class="th"><span designElement="text" textIndex="12"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >마일리지 사용</span></li>
								<li class="td pointcolor3">
									<span>(-)</span>
...
<?php if($TPL_VAR["cfg_reserve"]["cash_use"]=='Y'){?>
							<ul>
								<li class="th"><span designElement="text" textIndex="13"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >예치금 사용</span></li>
								<li class="td pointcolor3">
									(-)
...
<?php }?>
							<ul class="total">
								<li class="th"><span designElement="text" textIndex="14"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >최종 결제금액</span></li>
								<li class="td">
...
<?php if($TPL_VAR["members"]){?>
						<p class="od_sale_title2"><span designElement="text" textIndex="15"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >예상적립 혜택</span></p>
...
<?php }?>
								<span class="Dib">
									마일리지 최대 <?php echo get_currency_price($TPL_VAR["total_reserve"], 2,'','<strong id="total_reserve" class="gray_01">_str_price_</strong>')?>
...
<?php if($TPL_VAR["cfg_reserve"]["autoemoney"]){?>
							<li>
								상품평작성 시,
								<span class="Dib">
									마일리지 최대 <?php echo get_currency_price($TPL_VAR["cfg_reserve"]["autoemoney_review"], 2,'','<strong class="gray_01">_str_price_</strong>')?>
...
<?php if(in_array($TPL_VAR["naver_mileage_yn"],array('y','t'))){?>
						<p class="od_sale_title2" designElement="text" textIndex="16"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >네이버마일리지</p>
...
<?php }?>
						...
						<!-- ++++++++++++++++++++ 결제 수단 :: START ++++++++++++++++++++ -->
						<h3 class="title3"><span designElement="text" textIndex="17"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >결제 수단</span></h3>
...
<?php if($TPL_VAR["payment"]["payco"]){?>
							<li>
								...
								<p designElement="text" textIndex="18"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >페이코</p>
							</li>
<?php }?>
<?php if($TPL_VAR["payment"]["kakaopay"]){?>
							<li>
								...
								<p onclick="click_Kakaopay(this);" designElement="text" textIndex="19"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >카카오페이</p>
							</li>
<?php }?>
...
<?php if($TPL_VAR["payment"]["card"]){?>
							<li>
								...
								<p designElement="text" textIndex="20"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >신용카드</p>
							</li>
<?php }?>
<?php if($TPL_VAR["payment"]["account"]){?>
							<li>
								...
								<p designElement="text" textIndex="21"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >실시간<br />계좌이체</p>
							</li>
<?php }?>
<?php if($TPL_VAR["escrow"]["account"]){?>
							<li>
								...
								<p designElement="text" textIndex="22"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >실시간<br />계좌이체<br /><span class="desc No">(에스크로)</span></p>
							</li>
<?php }?>
<?php if($TPL_VAR["payment"]["virtual"]){?>
							<li>
								...
								<p designElement="text" textIndex="23"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >가상계좌</p>
							</li>
<?php }?>
<?php if($TPL_VAR["escrow"]["virtual"]){?>
							<li>
								...
								<p designElement="text" textIndex="24"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >가상계좌<br /><span class="desc No">(에스크로)</span></p>
							</li>
<?php }?>
<?php if($TPL_VAR["payment"]["cellphone"]){?>
							<li>
								<div class="cellphonepay <?php if($TPL_VAR["cellphonePayDisabled"]){?>overlay<?php }?>"  <?php if($TPL_VAR["cellphonePayDisabled"]){?>title="복합과세 미지원"<?php }?>>
									<label><input type="radio" name="payment" value="cellphone" <?php if($TPL_VAR["cellphonePayDisabled"]){?>disabled="disabled" <?php }?> data-cellphonePayDisabled="<?php echo $TPL_VAR["cellphonePayDisabled"]?>"/></label>
								</div>
								<p designElement="text" textIndex="25"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >휴대폰결제</p>
							</li>
<?php }?>
<?php }?>
<?php if($TPL_VAR["payment"]["bank"]){?>
							<li>
								...
								<p designElement="text" textIndex="26"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >무통장입금</p>
							</li>
<?php }?>
<?php if($TPL_VAR["payment"]["paypal"]){?>
							<li>
								...
								<p designElement="text" textIndex="27"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >Paypal</p>
							</li>
<?php }?>
<?php if($TPL_VAR["payment"]["eximbay"]){?>
							<li>
								...
								<p designElement="text" textIndex="28"  textTemplatePath="cmVzcG9uc2l2ZV92ZXIxX2RlZmF1bHRfZ2wvb3JkZXIvc2V0dGxlLmh0bWw=" >eximbay</p>
							</li>
<?php }?>
...
<?php }?>
						...
						<!-- ++++++++++++++++++++ 약관 동의 :: START ++++++++++++++++++++ -->
<?php if(!defined('__ISUSER__')||$TPL_VAR["policy_cancellation"]||$TPL_VAR["policy_third_party"]||$TPL_VAR["policy_delegation"]){?>
...
<?php }?>
<?php if($TPL_VAR["policy_third_party"]){?>
								<li>
									<a class="agree_view" href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >보기</a>
...
<?php }?>
<?php if($TPL_VAR["policy_delegation"]){?>
								<li>
									<a class="agree_view" href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >보기</a>
...
<?php }?>
<?php if($TPL_VAR["policy_cancellation"]){?>
								<li>
									<a class="agree_view" href="javascript:void(0)" hrefOri='amF2YXNjcmlwdDp2b2lkKDAp' >보기</a>
						...
						$(function() {
							$('#odAgreeList .agree_view').on('click', function() {
								...
								switch (agree_gubun) {
									...
									case 'delegation' : $('#odAgreeText5').show(); break;
...
<div id="odAgreeDetail" class="resp_layer_pop hide">
	...
	<div class="y_scroll_auto2">
		<div class="layer_pop_contents v5">
			<div id="odAgreeText1" class="od_agree_text hide"><?php echo nl2br($TPL_VAR["policy_agreement"])?></div>
			<div id="odAgreeText2" class="od_agree_text hide"><?php echo nl2br($TPL_VAR["policy_order"])?></div>
			<div id="odAgreeText3" class="od_agree_text hide"><?php echo nl2br($TPL_VAR["policy_third_party"])?></div>
			<div id="odAgreeText4" class="od_agree_text hide"><?php echo nl2br($TPL_VAR["policy_cancellation"])?></div>
			<div id="odAgreeText5" class="od_agree_text hide"><?php echo nl2br($TPL_VAR["policy_delegation"])?></div>
		</div>
	</div>
	<div class="layer_bottom_btn_area2">
		<button type="button" class="btn_resp size_c color5 Wmax" onclick="hideCenterLayer()">확인</button>
...
<?php }}?>
	...
	var gl_ssl_estimate_action  = "<?php echo sslAction(implode('',array('../prints/form_print_estimate?code=order&mode=',$TPL_VAR["mode"])))?>";
...
<?php if(defined('__ISUSER__')){?>gl_isuser					= '<?php echo defined('__ISUSER__')?>';<?php }?>
	...
	var gl_isdelegation	 = false;

<?php if($TPL_VAR["cancellation"]){?>gl_iscancellation	= true;<?php }?>
<?php if($TPL_VAR["policy_delegation"]){?>gl_isdelegation = true;<?php }?>
...
<script type="text/javascript" src="/app/javascript/js/order-settle.js?dummy=<?php echo date('Ymd')?>" charset="utf8"></script>
<script type="text/javascript" src="/app/javascript/js/skin-order-settle-resp.js?dummy=<?php echo date('Ymd')?>" charset="utf8"></script>
