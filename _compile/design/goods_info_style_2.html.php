<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/design/goods_info_style_2.html 000008773 */ 
...
<?php if(!$TPL_VAR["issample"]&&$TPL_VAR["style"]=='responsible'){?>
	...
	<ul class="goods_list <?php echo $TPL_VAR["display_key"]?> goods_info_style_2">
<?php }?>
...
<?php if($TPL_V1["summary"]){?>
			<div class="goodS_info displaY_goods_short_desc">
				<span class="areA"><?php echo $TPL_V1["summary"]?></span>
			</div>
<?php }?>
