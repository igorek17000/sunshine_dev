<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/setting/pg.html 000032831 */ ?>
...
<script type="text/javascript">
	...
	function setPaySetting(){
		...
		if(pgCompany == 'payco' || pgCompany == 'kakaopay' || pgCompany == 'daumkakaopay' || pgCompany == 'paypal' || pgCompany == 'eximbay'){
		...
		else if(pgCompany == 'naverpay' || pgCompany == 'talkbuy'){
	...
	function setVirtualinfo(){
		var selectVirtual = '<?php echo $TPL_VAR["config_system"]["pgCompany"]?>';
...
<?php if($TPL_VAR["config_system"]["not_use_payco"]=='y'||$TPL_VAR["config_system"]["not_use_payco"]==''){?>
...
<?php }else{?>
<input type="hidden" name="pay" value="<?php echo $TPL_VAR["config_system"]["pgCompany"]?>"/>
<?php }?>
...
<?php if($TPL_VAR["config_system"]["not_use_pg"]=='y'){?>
		<table class="table_basic v7 thl ">		
			<tr>
				...
				<td class="clear bdr0">
					<!--/ 대한민국 전자 결제 :: START /-->
					<div id="pgSettingContents" class="gabia-pannel-pay" isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>" service="s" group="p" pc="pg_kor"></div>
				</td>
			</tr>
		</table>
<?php }else{?>
...
<?php }?>
				...
				<td class="clear">
					<div class="pgInfoContents" code="<?php echo $TPL_VAR["config_system"]["pgCompany"]?>"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div>
				</td>
			</tr>
		</table>
<?php }?>
	...
	<div class="contents_dvs">
		...
		<input type="hidden" name="navercheckout_use" value="<?php echo $TPL_VAR["navercheckout"]["use"]?>" />
		<input type="hidden" name="talkbuy_use" value="<?php echo $TPL_VAR["talkbuy"]["use"]?>" />
		<table class="table_basic thl">	
<?php if($TPL_VAR["navercheckout"]["use"]=='y'){?>		
		<tr>
			<th>네이버페이 사용 <br/><button type="button" class="resp_btn v2" id="btnPaySetting" onclick="setOtherPay('naverpay');">설정</button></th>
			<td class="clear">
				<!--/ 네이버 페이 :: START /-->
				<div class="pgInfoContents" code="naverpay"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div>
			</td>
		</tr>
<?php }elseif($TPL_VAR["navercheckout"]["use"]=='test'){?>	
		<tr>
			<th>네이버페이 테스트 <br/><button type="button" class="resp_btn v2" id="btnPaySetting" onclick="setOtherPay('naverpay');">설정</button></th>
			<td class="clear">
				<!--/ 네이버 페이 :: START /-->
				<div class="pgInfoContents" code="naverpay"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div>
			</td>
		</tr>
<?php }elseif($TPL_VAR["navercheckout"]["use"]=='n'||!$TPL_VAR["navercheckout"]){?>	
		<tr>
			<th>네이버페이 미사용 <br/><button type="button" class="resp_btn v2" id="btnPaySetting" onclick="setOtherPay('naverpay');">설정</button></th>
			<td class="clear">
				<!--/ 네이버 페이 :: START /-->
				<div id="pgSettingContents" class="gabia-pannel-pay" isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>" service="s" group="p" pc="pg_naverpay"></div>
			</td>
		</tr>		
<?php }?>

		<tr>
			<th>카카오페이 구매 <?php if($TPL_VAR["talkbuy"]["use"]=='y'){?>사용<?php }else{?>미사용<?php }?> <br/><button type="button" class="resp_btn v2" id="btnPaySetting" onclick="setOtherPay('talkbuy');">설정</button></th>
			<td class="clear">
<?php if($TPL_VAR["talkbuy"]["use"]=='y'){?>
				<div class="pgInfoContents" code="talkbuy"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div>
<?php }else{?>
				<div id="pgSettingContents" class="gabia-pannel-pay" isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>" service="s" group="p" pc="pg_talkbuy"></div>
<?php }?>
			</td>
		</tr>
...
<?php if($TPL_VAR["config_system"]["not_use_kakao"]=='n'){?>	
		<tr>
			...
			<td class="clear"><div class="pgInfoContents" code="kakaopay"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div></td>
		</tr>		
<?php }?>
		
<?php if($TPL_VAR["config_system"]["not_use_daumkakaopay"]=='n'){?>	
		<tr>
			<th>카카오페이 사용 <br/><button type="button" class="resp_btn v2" id="btnPaySetting" onclick="setOtherPay('daumkakaopay');">설정</button></th>
			<td class="clear"><div class="pgInfoContents" code="daumkakaopay"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div></td>
		</tr>	
<?php }else{?>		
		<tr>
			<th>
			...
			<td class="clear">
				<!--/ 다음카카오 페이 :: START /-->
				<div id="pgSettingContents" class="gabia-pannel-pay" isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>" service="s" group="p" pc="pg_daumkakaopay"></div>
			</td>
		</tr>		
<?php }?>

<?php if($TPL_VAR["config_system"]["not_use_payco"]=='n'){?>	
		<tr>
			<th class="pay-title">
				페이코 사용
				<br/>
			...
			<td class="clear"><div class="pgInfoContents" code="payco"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div></td>
		</tr>		
<?php }else{?>		
		<tr>
			<th class="pay-title">
			...
			<td class="clear">
				<!--/ 페이코 :: START /-->
				<div id="pgSettingContents" class="gabia-pannel-pay" isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>" service="s" group="p" pc="pg_payco"></div>
			</td>
		</tr>		
<?php }?>
	</table>
...
<?php if($TPL_VAR["config_system"]["not_use_paypal"]=='n'){?>				
			<tr>
				<th>페이팔 사용 <br/><button type="button" class="resp_btn v2" id="btnPaySetting" onclick="setOtherPay('paypal');">설정</button></th>
				<td class="clear"><div class="pgInfoContents" code="paypal"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div></td>
			</tr>			
<?php }else{?>		
			<tr>
				...
				<td class="clear">
					<!--/ 페이팔 :: START /-->
					<div id="pgSettingContents" class="gabia-pannel-pay" isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>" service="s" group="p" pc="pg_paypal"></div>
				</td>
			</tr>		
<?php }?>		

<?php if($TPL_VAR["config_system"]["not_use_eximbay"]=='n'){?>			
			<tr>
				<th>엑심베이 사용 <br/><button type="button" class="resp_btn v2" id="btnPaySetting" onclick="setOtherPay('eximbay');">설정</button></th>
				<td class="clear"><div class="pgInfoContents" code="eximbay"  isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>"></div></td>
			</tr>
<?php }else{?>			
			<tr>
				...
				<td class="clear">
					<!--/ eximbay :: START /-->
					<div id="pgSettingContents" class="gabia-pannel-pay" isdemo="<?php echo $TPL_VAR["isdemo"]["isdemo"]?>" service="s" group="p" pc="pg_eximbay"></div>
				</td>
			</tr>			
<?php }?>
		...
		<tr>
			<td>
				<div id="virtual_info_kicc" class="virtual_info">
					...
					<div>
						<img src="/admin/skin/default/images/design/pg/img_setting_url_kicc.gif" />
					</div>
				</div>
