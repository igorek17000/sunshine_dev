<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/setting/_set_search_default_shipping.html 000006270 */ ?>
...
<?php if(serviceLimit('H_AD')){?>
			&nbsp;&nbsp;&nbsp;
			<label><input type="checkbox" name="shipping_etc_search[]" value="trust_ship" /> 입점사 상품이 연결된 배송그룹(본사위탁배송)</label>
<?php }?>
		</td>
	</tr>
	</table>
