<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/setting/joinform_sns.html 000043609 */ ?>
...
<input type="hidden" name="rest_key_k" id="rest_key_k" value="<?php if($TPL_VAR["sns"]["rest_key_k"]){?><?php echo $TPL_VAR["sns"]["rest_key_k"]?><?php }else{?><?php }?>">
<input type="hidden" name="use_k" id="use_k"  value="<?php echo $TPL_VAR["sns"]["use_k"]?>" />
<input type="hidden" name="type_k" id="type_k"  value="<?php echo $TPL_VAR["sns"]["type_k"]?>" />
<!-- facebook key -->
...
<input type="hidden" name="type_f" id="type_f"  value="<?php echo $TPL_VAR["sns"]["type_f"]?>" />
<!-- twitter key -->
		...
		<tr>
			...
			<td>
				<div class="resp_radio">
					<label><input type="radio" name="use_f_lay"  id="use_f_lay"  value="1"  <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]?> checked <?php }else{?><?php if($TPL_VAR["sns"]["use_f"]=="1"){?>checked<?php }?> <?php }?>   /> 사용함</label>
					<label><input type="radio" name="use_f_lay"  id="use_f_lay"  value="0"  <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]==""||$TPL_VAR["isdemo"]["isdemodisabled"]=="0"?> checked <?php }else{?><?php if($TPL_VAR["sns"]["use_f"]=="0"||$TPL_VAR["sns"]["use_f"]==""){?>checked<?php }?> <?php }?>   /> 사용 안 함</label>
				</div>
			</td>
		</tr>

<?php if($TPL_VAR["sns"]["type_f"]==''||$TPL_VAR["sns"]["type_f"]=='js'){?>
		<tr>
			<th>동작 방식 <span class="tooltip_btn" onclick="showTooltip(this, '/admin/tooltip/snsconf', '#tip16', 'sizeM')"></span></th>
			<td>
				<div class="resp_radio">				
					<label><input type="radio" name="type_f_lay" value="js" checked <?php if($TPL_VAR["sns"]["use_f"]=="0"||$TPL_VAR["sns"]["use_f"]==""){?>disabled<?php }?>/> 팝업창 로그인</label>
					<span class="tooltip_btn" onclick="showTooltip(this, '/admin/tooltip/snsconf', '#tip17', 'sizeM')"></span>
					<label><input type="radio" name="type_f_lay" value="rest" <?php if($TPL_VAR["sns"]["use_f"]=="0"||$TPL_VAR["sns"]["use_f"]==""){?>disabled<?php }?>/> 현재창 로그인 (권장)</label>
...
<div  id="snsdiv_k" class="snsdiv_k hide" >
	...
	<table class="joinform-user-table table_basic thl">
		<tr>
			...
			<td>
				<div class="resp_radio">
					<label><input type="radio" name="use_k_lay"  id="use_k_lay"  value="1"  <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]?> checked <?php }else{?><?php if($TPL_VAR["sns"]["use_k"]=="1"){?>checked<?php }?> <?php }?> /> 사용함</label>
					<label><input type="radio" name="use_k_lay"  id="use_k_lay"  value="0"  <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]=="0"||$TPL_VAR["isdemo"]["isdemodisabled"]==""?> checked <?php }else{?><?php if($TPL_VAR["sns"]["use_k"]=="0"||$TPL_VAR["sns"]["use_k"]==""){?>checked<?php }?> <?php }?> /> 사용 안 함</label>
				</div>
			</td>
		</tr>

<?php if($TPL_VAR["sns"]["type_k"]==''||$TPL_VAR["sns"]["type_k"]=='js'){?>
		<tr>
			<th>동작 방식 <span class="tooltip_btn" onclick="showTooltip(this, '/admin/tooltip/snsconf', '#tip19', 'sizeM')"></span></th>
			<td>
				<div class="resp_radio">
					<label><input type="radio" name="type_k_lay" value="js" checked <?php if($TPL_VAR["sns"]["use_k"]=="0"||$TPL_VAR["sns"]["use_k"]==""){?>disabled<?php }?>/> 팝업창 로그인</label>
					<span class="tooltip_btn" onclick="showTooltip(this, '/admin/tooltip/snsconf', '#tip20', 'sizeM')"></span>
					<label><input type="radio" name="type_k_lay" value="rest" <?php if($TPL_VAR["sns"]["use_k"]=="0"||$TPL_VAR["sns"]["use_k"]==""){?>disabled<?php }?>/> 현재창 로그인 (권장)</label>
...
<?php }?>
		...
		<tr class="row_rest_k <?php if($TPL_VAR["sns"]["type_k"]==''||$TPL_VAR["sns"]["type_k"]=='js'){?>hide<?php }?>">
			<th>Rest API Key</th>
			<td><input type='text'  name="rest_key_k_lay"  id="rest_key_k_lay" value="<?php if($TPL_VAR["sns"]["rest_key_k"]){?><?php echo $TPL_VAR["sns"]["rest_key_k"]?><?php }else{?><?php }?>" class="wp95" <?php if($TPL_VAR["sns"]["use_k"]=="0"||$TPL_VAR["sns"]["use_k"]==""){?>disabled<?php }?>></td>
		</tr>
	</table>
...
<div  id="snsdiv_a" class="snsdiv_a hide" >
	...
	<table class="table_basic thl">
		<tr>
			...
			<td>
				<div class="resp_radio">
					<label><input type="radio" name="use_a_lay"  id="use_a_lay"  value="1"  <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]?> checked <?php }else{?><?php if($TPL_VAR["sns"]["use_a"]=="1"){?>checked<?php }?> <?php }?> /> 사용함</label>
					<label><input type="radio" name="use_a_lay"  id="use_a_lay"  value="0"  <?php if($TPL_VAR["isdemo"]["isdemo"]){?> <?php echo $TPL_VAR["isdemo"]["isdemodisabled"]=="0"||$TPL_VAR["isdemo"]["isdemodisabled"]==""?> checked <?php }else{?><?php if($TPL_VAR["sns"]["use_a"]=="0"||$TPL_VAR["sns"]["use_a"]==""){?>checked<?php }?> <?php }?> /> 사용 안 함</label>
				</div>
			</td>
		</tr>
		<tr>
