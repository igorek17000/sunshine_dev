<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/setting/shipping_group_regist.html 000024695 */ ?>
...
<?php if($TPL_VAR["reg_type"]=='modify'){?><button type="button" onclick="shipping_copy(<?php echo $_GET["shipping_group_seq"]?>);" class="resp_btn v2 size_L">복사</button><?php }?>			
		</div>
<?php }?>
	</div>
</div>
...
<div class="contents_dvs v2">
	...
	<div class="resp_message">
		...
		<div>- 카카오페이 구매 배송 규정 안내 <a href="https://www.firstmall.kr/customer/faq/1631" target="_blank" class="resp_btn_txt">자세히 보기</a></div>					
	</div>
</div>
<!-- 배송가능국가:대한민국 :: END -->
