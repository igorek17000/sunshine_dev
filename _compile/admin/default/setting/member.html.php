<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/setting/member.html 000007013 */ ?>
...
<!-- 상단 단계 링크 : 시작 -->
<?php if($TPL_VAR["admin_skin_type"]=='org'){?>
<ul id="mainTab" class="tab_01 v2 tabEvent mt20">
	<li><a href="javascript:void(0);" onclick="formMove('joinform',1);">로그인 및 회원가입</a></li>
	<li><a href="javascript:void(0);" onclick="formMove('withdraw',2);">회원정보 변경</a></li>
	<li><a href="javascript:void(0);" onclick="formMove('approval',3);">승인 혜택</a></li>
	<li><a href="javascript:void(0);" onclick="formMove('grade',4);">등급</a></li>
	<li><a href="javascript:void(0);" onclick="formMove('member_sale',5);">등급별 구매혜택</a></li>
	<li><a href="javascript:void(0);" onclick="formMove('agreement',6);">약관 및 개인정보처리방침</a></li>
	<li><a href="javascript:void(0);" onclick="formMove('realname',8);">본인확인</a></li>	
</ul>	
<?php }?>
