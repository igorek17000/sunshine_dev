<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/setting/add_national_view.html 000027057 */ 
...
<?php if($TPL_K1=='std'){?>
							<div class="delivery-limit-lay mb5">
...
<?php if($TPL_K1=='std'||$TPL_K1=='add'||$TPL_K1=='hop'){?>
							<div class="cost_shipping_area">
								<table class="table_basic wauto v7" >
								<thead>
								<tr>
...
<?php }}?>
			...
			<tr>
				...
				<td class="its-td center nonpd clear">
					...
					<tr>
						<td class="its-td center nonpd" width="85px" >반품</td>
						<td class="its-td left">
