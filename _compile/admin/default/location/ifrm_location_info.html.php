<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/location/ifrm_location_info.html 000008157 */ ?>
...
<script type="text/javascript" src="/app/javascript/js/admin/category_ifrm.js?v=<?php echo date('Ymd')?>"></script>
<script type="text/javascript">
	var categoryType 	= 'location';
	var categoryCode 	= '<?php echo $TPL_VAR["locationCode"]?>';
	var categoryUrl 	= gl_protocol+"<?php echo $_SERVER["HTTP_HOST"]?>/goods/location?code=";
	$(function () {
...
<input type="hidden" name="categoryCode" value="<?php echo $TPL_VAR["locationCode"]?>" />
...
<div class="warp ml15">
	...
	<tr>
		<th>지역명</th>
		<td><?php echo $TPL_VAR["locationData"]["title"]?></td>
		<th>지역 번호</th>
		<td>
			<?php echo $TPL_VAR["locationData"]["location_code"]?>
...
<?php }?>
	...
	<tr>
		<th>접속 허용</th>
		<td><?php echo $TPL_VAR["access_limit_txt"]?></td>
		<th>접속 기한 제한</th>
		<td>
