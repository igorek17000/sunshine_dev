<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/statistic/advanced_statistics.html 000008098 */ ?>
...
<?php }?>
	...
	$.ajax({
		...
		data: "pageType="+pageType+"&goods_seq=<?php echo $TPL_VAR["sc"]["goods_seq"]?>"+addParams,
...
<?php }else{?>
	...
	<tr>
		<td width="10"><img src="/admin/skin/default/images/design/statsbar_bg_f.gif" /></td>
		<td class="head-title">
			이 상품의 
<?php }?>
		...
		<img src="/admin/skin/default/images/common/btn_plus_gray.png" align="absmiddle" style="cusor:pointer;" onclick="openMoreStats();" />
<?php if($TPL_VAR["sc"]["ispop"]=='pop'){?>
		</div>
...
<?php }else{?>
		...
		<td width="10"><img src="/admin/skin/default/images/design/statsbar_bg_b.gif" /></td>
	</tr>
	</table>
