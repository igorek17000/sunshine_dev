<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/o2o/o2osetting/o2o_regist.html 000018991 */ 
...
<div id="page-title-bar-area">
	...
	<div id="page-title-bar">	
		...
		<div class="page-title">
			<h2>매장 <?php if($TPL_VAR["shipping_address"]["shipping_address_seq"]){?>수정<?php }else{?>등록<?php }?></h2>
		</div>
			...
			<tr>
				...
				<td>
					...
					<div class="inter_area international_korea mt5">
						...
						<input type="text" name="zoneAddressDetail" value="<?php echo $TPL_VAR["shipping_address"]["address_detail"]?>" size="65" title="상세주소" class="mt5" />
					</div>
	...
	<div class="contents_dvs">
		...
		<table class="table_basic thl">				
			<tr>
				...
				<td>
					<div class="resp_radio">
						<label><input type="radio" name="store_info_display_yn" value="Y" <?php if($TPL_VAR["shipping_address"]["store_info_display_yn"]=='Y'){?> checked <?php }?>> 노출</label>	
			...
			<tr class="area_store_info">
				...
				<td>
					<label class="resp_checkbox"><input type="checkbox" name="default_yn" id="default_yn" value="Y" <?php if($TPL_VAR["shipping_address"]["default_yn"]=='Y'){?> checked <?php }?>> 사용</label>	
	...
	<div class="contents_dvs">
		...
		<table class="table_basic thl">					
			<tr>
				...
				<td>
					<div class="resp_radio">
						<label><input type="radio" name="store_o2o_use_yn" value="Y" <?php if($TPL_VAR["shipping_address"]["store_o2o_use_yn"]=='Y'){?> checked <?php }?>> 사용함</label>		
