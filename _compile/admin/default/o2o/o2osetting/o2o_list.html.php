<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/o2o/o2osetting/o2o_list.html 000009695 */ 
...
<?php }}?>
	...
	<!-- 주소 검색 부분 :: END -->
	<div class="table_row_frame <?php if($TPL_VAR["checkO2OService"]){?><?php }else{?>hide<?php }?>">	
		<div class="dvs_top">
...
<?php if($TPL_loop_1){foreach($TPL_VAR["loop"] as $TPL_V1){?>
			...
			>
				<td>
					<input type="checkbox" class="chk resp_checkbox" name="add_chk[]" value="<?php echo $TPL_V1["shipping_address_seq"]?>" <?php if($TPL_V1["wh_use"]=='N'){?>disabled<?php }?> 
...
<?php }?>
				...
				<td>
				<button type="button" onclick="insert_address_pop('<?php echo $TPL_V1["shipping_address_seq"]?>');" class="resp_btn v2">수정</button>					
				</td>
			</tr>
<?php }}else{?>
			<tr>
