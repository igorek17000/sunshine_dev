<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/popup/shipping_address_pop.html 000015943 */ ?>
<style type="text/css">
/* 장소리스트 CSS */
...
function insert_address_pop(type){
	...
	openDialog("장소 등록/수정", "shipping_address_insert", {"width":600,"height":480});
}
...
<!-- 리스트 부분 :: START -->
	...
	<!-- control button -->
		<div class="control-btn r_dvs mt10 mb10">		
