<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/popup/shipping_address_list.html 000005088 */ 
...
<tr class="address_tr_<?php echo $TPL_V1["shipping_address_seq"]?>" add_type="<?php echo $TPL_V1["add_type"]?>"
	...
	<td class="center nonpd" height="30">
		<label class="resp_checkbox"><input type="checkbox" name="add_chk[]" value="<?php echo $TPL_V1["shipping_address_seq"]?>" <?php if($TPL_V1["wh_use"]=='N'||$TPL_V1["is_selected"]=='Y'){?>disabled<?php }?> /></label>
	</td>
