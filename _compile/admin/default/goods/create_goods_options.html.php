<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admin/skin/default/goods/create_goods_options.html 000061998 */ 
...
<?php if($TPL_opts_loop_1){$TPL_I1=-1;foreach($TPL_VAR["opts_loop"] as $TPL_V1){$TPL_I1++;?>
				<tr>
					<td class="center">
						<span <?php if($TPL_I1== 0){?>class="hide"<?php }?>><button type="button" class="btn_minus btnplusminus" onclick="$(this).parents('tr').remove();"></button></span>
					</td>
					<td class="center">
...
<?php }}?>
					...
					<td class="center">
						<input type="text" name="optionMakeName[]" class="resp_text wp95" value="<?php echo $TPL_V1["title"]?>" />
					</td>
<?php if(serviceLimit('H_NFR')){?>
					<td class="center">
<?php if($TPL_V1["newtype"][$TPL_I1]&&$TPL_V1["newtype"][$TPL_I1]!='none'&&strstr($TPL_V1["type"],'goodsoption_')){?>
						<select  name="optionMakespecial[]"  readonly="readonly" disabled="disabled" id="goodsoption_<?php echo $TPL_I1?>_<?php echo $TPL_V1["newtype"][$TPL_I1]?>" class="<?php echo $TPL_V1["newtype"][$TPL_I1]?>select wp95"  onchange="goodsoptionspecialform($(this), $(this).parents('tr'));">
...
<?php }else{?>
						<select name="optionMakespecial[]"  id="goodsoption_<?php echo $TPL_I1?>_<?php echo $TPL_V1["newtype"][$TPL_I1]?>" class="<?php echo $TPL_V1["newtype"][$TPL_I1]?>select wp95" onchange="goodsoptionspecialform($(this), $(this).parents('tr'));">
							<option value="" >없음</option>
<?php if($TPL_VAR["sc"]["socialcp_input_type"]){?>
							<option value="address"  <?php if($TPL_V1["newtype"][$TPL_I1]=='address'){?> selected="selected" <?php }?>>지역</option>
							<option value="date"  <?php if($TPL_V1["newtype"][$TPL_I1]=='date'){?> selected="selected" <?php }?>>날짜</option>
...
<?php if(is_array($TPL_R2=$TPL_V1["goodsoptionloop"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
						<span class="goodsoption_<?php echo $TPL_V2["codeform_seq"]?> goodsoptionsublay <?php if((($TPL_V1["code_seq"]!=$TPL_V2["codeform_seq"]&&strstr($TPL_V1["type"],'goodsoption_'))||(!strstr($TPL_V1["type"],'goodsoption_')))){?>hide<?php }?> ">
							<button type="button" class="resp_btn v2 <?php echo $TPL_V2["label_type"]?>btn" onclick="goodsOptionBtn(this);" layerid="<?php echo $TPL_V2["label_type"]?><?php echo $TPL_V2["codeform_seq"]?>_lay" label_type="<?php echo $TPL_V2["label_type"]?>"  codeform_seq="<?php echo $TPL_V2["codeform_seq"]?>" label_title="<?php echo $TPL_V2["label_title"]?>"  label_newtype="<?php echo $TPL_V2["label_newtype"]?>"  label_color="<?php echo $TPL_V2["label_color"]?>" label_zipcode="<?php echo $TPL_V2["label_zipcode"]?>"  label_address_type="<?php echo $TPL_V2["label_address_type"]?>"  label_address="<?php echo $TPL_V2["label_address"]?>"  label_address_street="<?php echo $TPL_V2["label_address_street"]?>"  label_addressdetail="<?php echo $TPL_V2["label_addressdetail"]?>" label_biztel="<?php echo $TPL_V2["label_biztel"]?>" label_address_commission="<?php echo $TPL_V2["label_address_commission"]?>"  label_codedate="<?php echo $TPL_V2["label_codedate"]?>"  label_sdayinput="<?php echo $TPL_V2["label_sdayinput"]?>" label_fdayinput="<?php echo $TPL_V2["label_fdayinput"]?>" label_dayauto_type="<?php echo $TPL_V2["label_dayauto_type"]?>" label_sdayauto="<?php echo $TPL_V2["label_sdayauto"]?>" label_fdayauto="<?php echo $TPL_V2["label_fdayauto"]?>" label_dayauto_day="<?php echo $TPL_V2["label_dayauto_day"]?>" >선택</button>
						</span>
<?php }}?>
						</span>

						<input type="text" name="optionMakeValue[]" class="resp_text wp60" value="<?php echo $TPL_V1["opt"]?>" onblur="setDefaultPrice(this);" />
						...
						<div class="optionMakeSpecial ">
							...
							<div class="optionMakeSpecialsub optionMakedayinput <?php if($TPL_V1["newtype"][$TPL_I1]!='dayinput'){?> hide <?php }?>">
								<input type="text" name="optionMakesdayinput[]" id="addoptionMakesdayinput<?php echo $TPL_I1?>"  value="<?php echo $TPL_V1["sdayinput"]?>" class="optionMakesdayinput datepicker"  maxlength="10" size="10" />
								~
								<input type="text" name="optionMakefdayinput[]" id="addoptionMakefdayinput<?php echo $TPL_I1?>" value="<?php echo $TPL_V1["fdayinput"]?>" class="optionMakefdayinput datepicker" maxlength="10" size="10" />
							</div>
							<div class="optionMakeSpecialsub optionMakenewdayauto  <?php if($TPL_V1["newtype"][$TPL_I1]!='dayauto'){?> hide <?php }?>">
								<span> '결제확인' 후
									...
									<input type="text" name="optionMakesdayauto[]"  value="<?php echo $TPL_V1["sdayauto"]?>" class="optionMakesdayauto"  maxlength="10" size="2" />일 <span class="optionMakenewdayautolaytitle"><?php if($TPL_V1["dayauto_type"]=='day'){?>이후<?php }?></span>부터 +
									<div class="mt5">
										<input type="text" name="optionMakefdayauto[]"  value="<?php echo $TPL_V1["fdayauto"]?>" class="optionMakefdayauto"  maxlength="10" size="2" />일
					...
					<td class="center">
						<input type="text" name="optionMakePrice[]" class="resp_text wp95" value="<?php echo $TPL_V1["price"]?>"  title="예) 0,0,0" />
					</td>
				</tr>
<?php }}?>
<?php }else{?>
...
<?php if(is_array($TPL_R2=$TPL_V1["code_arr"])&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
			<tr id=" labelTr">
				<td class="center">
					<label class="resp_checkbox"><input type="checkbox" name="<?php echo $TPL_V1["label_type"]?>[]" class="chk null labelCheckbox_<?php echo $TPL_V1["codeform_seq"]?>"  codeform_seq="<?php echo $TPL_V1["codeform_seq"]?>"  label_type="<?php echo $TPL_V1["label_type"]?>"  label_id="<?php echo $TPL_V1["label_id"]?>" value="<?php echo $TPL_V2["code"]?>" label_value="<?php echo $TPL_V2["value"]?>"   label_newtype="<?php echo $TPL_V1["label_newtype"]?>"  label_color="<?php echo $TPL_V2["colors"]?>" label_zipcode="<?php echo $TPL_V2["zipcode"]?>" label_address_type="<?php echo $TPL_V2["address_type"]?>" label_address="<?php echo $TPL_V2["address"]?>" label_address_street="<?php echo str_replace(',','＆',$TPL_V2["address_street"])?>" label_addressdetail="<?php echo $TPL_V2["addressdetail"]?>" label_biztel="<?php echo $TPL_V2["biztel"]?>"  label_address_commission="<?php echo $TPL_V2["address_commission"]?>"  label_codedate="<?php echo $TPL_V2["codedate"]?>"  label_sdayinput="<?php echo $TPL_V2["sdayinput"]?>" label_fdayinput="<?php echo $TPL_V2["fdayinput"]?>" label_dayauto_type="<?php echo $TPL_V2["dayauto_type"]?>" label_sdayauto="<?php echo $TPL_V2["sdayauto"]?>" label_fdayauto="<?php echo $TPL_V2["fdayauto"]?>"  label_dayauto_day="<?php echo $TPL_V2["dayauto_day"]?>"  <?php if($TPL_V2["default"]=="Y"){?> default="checked" <?php }?>></label>
				</td>
				<td class="center"><?php echo $TPL_V2["value"]?>
				...
				<td class="center"><?php echo $TPL_V2["code"]?></td>
			</tr>
<?php }}?>
			</tbody>
			</table>
		...
		<div class="footer">
			...
			<button type="button" class="resp_btn active size_XL" id="<?php echo $TPL_V1["label_type"]?><?php echo $TPL_V1["codeform_seq"]?>CodeApply" onclick="setGoodsOption(this);"  codeform_seq="<?php echo $TPL_V1["codeform_seq"]?>"  label_type="<?php echo $TPL_V1["label_type"]?>" label_newtype="<?php echo $TPL_V1["label_newtype"]?>"   label_id="<?php echo $TPL_V1["label_id"]?>" layer_id="<?php echo $TPL_V1["label_type"]?><?php echo $TPL_V1["codeform_seq"]?>_lay">선택</button>
			<button type="button" class="resp_btn v3 size_XL" onclick="closeDialog('<?php echo $TPL_V1["label_type"]?><?php echo $TPL_V1["codeform_seq"]?>_lay')">취소</button>
		</div>
	</div>
	<!-- <?php }}?> -->
