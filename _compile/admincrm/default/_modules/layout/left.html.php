<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/admincrm/skin/default/_modules/layout/left.html 000017301 */ 
...
<?php if($TPL_VAR["mall_t_check"]=='Y'){?><span style="position:relation;padding:0px 5px 0px 5px;float:right;color:#FFBB00;border:1px solid;">TEST</span><?php }?>
			...
			<tr style="cursor:pointer;" onclick="location.href='../member/emoney_list?member_seq=<?php echo $_GET["member_seq"]?>';">
				...
				<td class="crmLeftMenuTitle<?php if(uri_string()=='admincrm/member/emoney_list'){?>On<?php }?>">마일리지 내역<div class="crmLeftMenuCount" style="width:80px !important; text-align:right; padding-right:10px;"><?php echo get_currency_price($TPL_VAR["userEmoney"])?></div></td>
			</tr>
