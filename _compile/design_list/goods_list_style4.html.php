<?php /* Template_ 2.2.6 2022/03/07 12:32:25 /www/suns_firstmall_kr/data/design_list/goods_list_style4.html 000004955 */ 
...
<?php if($TPL_V1["review_count"]> 0){?>
		<li class="goods_review_area displaY_review_score_a">
			<span class="ev_active2"><b style="width:<?php echo round($TPL_V1["review_sum"]/($TPL_V1["review_count"]* 5)* 100, 1)?>%;"></b></span>
			<span class="displaY_review_score_b"><span class="nuM"><?php echo round($TPL_V1["review_sum"]/$TPL_V1["review_count"], 1)?></span></span>
			<span class="displaY_review_score_c">(<?php echo $TPL_V1["review_count"]?>)</span>
		</li>
<?php }?>
